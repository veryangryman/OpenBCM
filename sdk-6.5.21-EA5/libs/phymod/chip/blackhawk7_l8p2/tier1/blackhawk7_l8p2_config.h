...
if (!(((BLACKHAWK7_L8P2_REVID_MODEL_DEFAULT_A0 == revid) && (BLACKHAWK7_L8P2_REVID2_DEFAULT_A0 == revid2) && (BLACKHAWK7_L8P2_AFE_IPVERSION_ID_DEFAULT_A0 == ipversion)) ||   \
    ...
    EFUN_PRINTF(("ERROR: IP Hardware ID Mismatch. Expected: 0x%08X (A0) or %08X (B0). Actual: 0x%08X.\n",                                          \
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_l8p2_ucode_crc_verify(srds_access_t *sa__, uint16_t ucode_len, uint16_t expected_crc_value);
