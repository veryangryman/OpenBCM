...
extern uint32_t tscbh_gen3_spd_id_entry_100g_4lane_no_fec_25[TSCBH_GEN3_SPEED_ID_ENTRY_SIZE];
...
int tscbh_gen3_phy_speed_config_get(const phymod_phy_access_t* phy, phymod_phy_speed_config_t* speed_config)
{
    ...
    if (!PHYMOD_DEVICE_OP_MODE_PCS_BYPASS_GET(phy->device_op_mode)) {
        ...
        if ((an_en && an_done) && (speed_id != TSCBH_GEN3_SPEED_ID_INDEX_100G_4_LANE_CL73_KR4) &&
        ...
        for (i = 0; i < TSCBH_GEN3_AUTONEG_SPEED_ID_COUNT; i++) {
            if (gsh_header_enable) {
                ...
                if (an_fec_override_enable &&
                    (i == TSCBH_GEN3_SPEED_ID_INDEX_100G_4_LANE_CL73_KR4 || i == TSCBH_GEN3_SPEED_ID_INDEX_100G_4_LANE_CL73_CR4)) {
                    /* Skip loading AN entry for CL73 100Gx4 if AN FEC override is enabled */
                    continue;
                }
                PHYMOD_IF_ERR_RETURN
        ...
        if (enable) {
            PHYMOD_IF_ERR_RETURN
                (phymod_mem_write(&phy_copy.access, phymodMemSpeedIdTable,
                                  ...
                                  &tscbh_gen3_spd_id_entry_100g_4lane_no_fec_25[0]));
            PHYMOD_IF_ERR_RETURN
                (phymod_mem_write(&phy_copy.access, phymodMemSpeedIdTable,
            ...
            PHYMOD_IF_ERR_RETURN
                (phymod_mem_write(&phy_copy.access, phymodMemSpeedIdTable,
                                  TSCBH_GEN3_SPEED_ID_INDEX_100G_4_LANE_CL73_KR4,
                                  &tscbh_gen3_spd_id_entry_25[TSCBH_GEN3_SPEED_ID_INDEX_100G_4_LANE_CL73_KR4][0]));
            PHYMOD_IF_ERR_RETURN
                (phymod_mem_write(&phy_copy.access, phymodMemSpeedIdTable,
                                  TSCBH_GEN3_SPEED_ID_INDEX_100G_4_LANE_CL73_CR4,
                                  &tscbh_gen3_spd_id_entry_25[TSCBH_GEN3_SPEED_ID_INDEX_100G_4_LANE_CL73_CR4][0]));
        }
    }
    return PHYMOD_E_NONE;
}
