...
static shr_error_e
j2p_a0_dnx_data_lif_global_lif_global_outlif_bta_enable_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_lif;
    int submodule_index = dnx_data_lif_submodule_global_lif;
    int define_index = dnx_data_lif_global_lif_define_global_outlif_bta_enable;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2p_a0_dnx_data_lif_global_lif_global_lif_bta_max_val_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_lif;
...
static shr_error_e
j2p_a0_dnx_data_lif_out_lif_global_ipv6_outlif_bta_sop_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_lif;
    ...
    define->default_data = dnx_data_lif.global_lif.global_outlif_bta_enable_get(unit) == 1 ? 40 : 0;

    
    define->data = dnx_data_lif.global_lif.global_outlif_bta_enable_get(unit) == 1 ? 40 : 0;
...
static shr_error_e
j2p_a0_dnx_data_lif_out_lif_global_vxlan_outlif_bta_sop_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_lif;
    ...
    define->default_data = dnx_data_lif.global_lif.global_outlif_bta_enable_get(unit) == 1 ? 36 : 0;

    
    define->data = dnx_data_lif.global_lif.global_outlif_bta_enable_get(unit) == 1 ? 36 : 0;
...
static shr_error_e
j2p_a0_dnx_data_lif_out_lif_global_mpls_outlif_bta_sop_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_lif;
    ...
    define->default_data = dnx_data_lif.global_lif.global_outlif_bta_enable_get(unit) == 1 ? 4 : 0;

    
    define->data = dnx_data_lif.global_lif.global_outlif_bta_enable_get(unit) == 1 ? 4 : 0;
...
static shr_error_e
j2p_a0_dnx_data_lif_out_lif_global_srv6_outlif_bta_sop_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_lif;
    ...
    define->default_data = dnx_data_lif.global_lif.global_outlif_bta_enable_get(unit) == 1 ? 16 : 0;

    
    define->data = dnx_data_lif.global_lif.global_outlif_bta_enable_get(unit) == 1 ? 16 : 0;
    ...
    int unit)
{
    ...
    data_index = dnx_data_lif_global_lif_define_global_outlif_bta_enable;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_lif_global_lif_global_outlif_bta_enable_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_lif_global_lif_global_lif_bta_max_val_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_lif_out_lif_global_ipv6_outlif_bta_sop_set;
    data_index = dnx_data_lif_out_lif_define_global_vxlan_outlif_bta_sop;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_lif_out_lif_global_vxlan_outlif_bta_sop_set;
    data_index = dnx_data_lif_out_lif_define_global_mpls_outlif_bta_sop;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_lif_out_lif_global_mpls_outlif_bta_sop_set;
    data_index = dnx_data_lif_out_lif_define_global_srv6_outlif_bta_sop;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_lif_out_lif_global_srv6_outlif_bta_sop_set;
