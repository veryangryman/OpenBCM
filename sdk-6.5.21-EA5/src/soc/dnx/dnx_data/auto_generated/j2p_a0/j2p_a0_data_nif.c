...
static shr_error_e
j2p_a0_dnx_data_nif_eth_is_12G_supported_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_eth;
    int define_index = dnx_data_nif_eth_define_is_12G_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2p_a0_dnx_data_nif_features_toggle_lag_failover_on_link_status_up_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_features;
    int feature_index = dnx_data_nif_features_toggle_lag_failover_on_link_status_up;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_nif_eth_define_is_12G_supported;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_nif_eth_is_12G_supported_set;
    ...
    data_index = dnx_data_nif_features_toggle_lag_failover_on_link_status_up;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_nif_features_toggle_lag_failover_on_link_status_up_set;
