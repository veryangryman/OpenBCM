...
static shr_error_e
j2p_a0_dnx_data_sch_flow_flex_quartet_region_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_sch;
    int submodule_index = dnx_data_sch_submodule_flow;
    int define_index = dnx_data_sch_flow_define_flex_quartet_region_size;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2p_a0_dnx_data_sch_flow_nof_flex_quartet_regions_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_sch;
    int submodule_index = dnx_data_sch_submodule_flow;
    int define_index = dnx_data_sch_flow_define_nof_flex_quartet_regions;
    SHR_FUNC_INIT_VARS(unit);

    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    
    define->default_data = dnx_data_sch.flow.nof_se_get(unit)/dnx_data_sch.flow.flex_quartet_region_size_get(unit);

    
    define->data = dnx_data_sch.flow.nof_se_get(unit)/dnx_data_sch.flow.flex_quartet_region_size_get(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_sch_flow_define_flex_quartet_region_size;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_sch_flow_flex_quartet_region_size_set;
    data_index = dnx_data_sch_flow_define_nof_flex_quartet_regions;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_sch_flow_nof_flex_quartet_regions_set;
