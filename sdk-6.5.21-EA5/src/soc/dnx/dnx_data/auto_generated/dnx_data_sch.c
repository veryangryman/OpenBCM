    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_sch_flow_define_flex_quartet_region_size].name = "flex_quartet_region_size";
    submodule_data->defines[dnx_data_sch_flow_define_flex_quartet_region_size].doc = "Number of flows in a flexible quartet region";
    
    submodule_data->defines[dnx_data_sch_flow_define_flex_quartet_region_size].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_sch_flow_define_nof_flex_quartet_regions].name = "nof_flex_quartet_regions";
    submodule_data->defines[dnx_data_sch_flow_define_nof_flex_quartet_regions].doc = "Number of flexible quartet regions in a core";
    
    submodule_data->defines[dnx_data_sch_flow_define_nof_flex_quartet_regions].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_sch_flow_flex_quartet_region_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_sch, dnx_data_sch_submodule_flow, dnx_data_sch_flow_define_flex_quartet_region_size);
}

uint32
dnx_data_sch_flow_nof_flex_quartet_regions_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_sch, dnx_data_sch_submodule_flow, dnx_data_sch_flow_define_nof_flex_quartet_regions);
}
