    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_port_pp_general_define_rch_removal_port_field_profile].name = "rch_removal_port_field_profile";
    submodule_data->defines[dnx_data_port_pp_general_define_rch_removal_port_field_profile].doc = "field profile used for rch removal in iPMF for RCH header_type ports";
    
    submodule_data->defines[dnx_data_port_pp_general_define_rch_removal_port_field_profile].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_port_pp_general_define_rch_extended_encap_port_field_profile].name = "rch_extended_encap_port_field_profile";
    submodule_data->defines[dnx_data_port_pp_general_define_rch_extended_encap_port_field_profile].doc = "field profile used for rch extended encapsulation port";
    
    submodule_data->defines[dnx_data_port_pp_general_define_rch_extended_encap_port_field_profile].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_port_pp_general_rch_removal_port_field_profile_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_port_pp, dnx_data_port_pp_submodule_general, dnx_data_port_pp_general_define_rch_removal_port_field_profile);
}

uint32
dnx_data_port_pp_general_rch_extended_encap_port_field_profile_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_port_pp, dnx_data_port_pp_submodule_general, dnx_data_port_pp_general_define_rch_extended_encap_port_field_profile);
}
