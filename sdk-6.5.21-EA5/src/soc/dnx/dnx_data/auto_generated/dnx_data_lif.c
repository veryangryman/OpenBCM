    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_lif_global_lif_define_global_outlif_bta_enable].name = "global_outlif_bta_enable";
    submodule_data->defines[dnx_data_lif_global_lif_define_global_outlif_bta_enable].doc = "Indicated whether global outlif bta enabled";
    
    submodule_data->defines[dnx_data_lif_global_lif_define_global_outlif_bta_enable].flags |= DNXC_DATA_F_NUMERIC;
...
uint32
dnx_data_lif_global_lif_global_outlif_bta_enable_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_lif, dnx_data_lif_submodule_global_lif, dnx_data_lif_global_lif_define_global_outlif_bta_enable);
}
