    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_instru_synced_counters_define_start_lags].name = "start_lags";
    submodule_data->defines[dnx_data_instru_synced_counters_define_start_lags].doc = "";
    
    submodule_data->defines[dnx_data_instru_synced_counters_define_start_lags].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_instru_synced_counters_define_nif_traffic_not_working].name = "nif_traffic_not_working";
    submodule_data->defines[dnx_data_instru_synced_counters_define_nif_traffic_not_working].doc = "";
    
    submodule_data->defines[dnx_data_instru_synced_counters_define_nif_traffic_not_working].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_instru_synced_counters_define_shifting_continuous_non_continuous_not_working].name = "shifting_continuous_non_continuous_not_working";
    submodule_data->defines[dnx_data_instru_synced_counters_define_shifting_continuous_non_continuous_not_working].doc = "";
    
    submodule_data->defines[dnx_data_instru_synced_counters_define_shifting_continuous_non_continuous_not_working].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_instru_synced_counters_start_lags_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_instru, dnx_data_instru_submodule_synced_counters, dnx_data_instru_synced_counters_define_start_lags);
}

uint32
dnx_data_instru_synced_counters_nif_traffic_not_working_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_instru, dnx_data_instru_submodule_synced_counters, dnx_data_instru_synced_counters_define_nif_traffic_not_working);
}

uint32
dnx_data_instru_synced_counters_shifting_continuous_non_continuous_not_working_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_instru, dnx_data_instru_submodule_synced_counters, dnx_data_instru_synced_counters_define_shifting_continuous_non_continuous_not_working);
}
