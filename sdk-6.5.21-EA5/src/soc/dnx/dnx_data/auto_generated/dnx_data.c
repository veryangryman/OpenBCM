    ...
    int unit)
{
    ...
    dnx_data_instru.synced_counters.start_lags_get = dnx_data_instru_synced_counters_start_lags_get;
    dnx_data_instru.synced_counters.nif_traffic_not_working_get = dnx_data_instru_synced_counters_nif_traffic_not_working_get;
    dnx_data_instru.synced_counters.shifting_continuous_non_continuous_not_working_get = dnx_data_instru_synced_counters_shifting_continuous_non_continuous_not_working_get;
    ...
    dnx_data_lif.global_lif.global_outlif_bta_enable_get = dnx_data_lif_global_lif_global_outlif_bta_enable_get;
    ...
    dnx_data_nif.eth.is_12G_supported_get = dnx_data_nif_eth_is_12G_supported_get;
    ...
    dnx_data_port_pp.general.rch_removal_port_field_profile_get = dnx_data_port_pp_general_rch_removal_port_field_profile_get;
    dnx_data_port_pp.general.rch_extended_encap_port_field_profile_get = dnx_data_port_pp_general_rch_extended_encap_port_field_profile_get;
    ...
    dnx_data_sch.flow.flex_quartet_region_size_get = dnx_data_sch_flow_flex_quartet_region_size_get;
    dnx_data_sch.flow.nof_flex_quartet_regions_get = dnx_data_sch_flow_nof_flex_quartet_regions_get;
