    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_nif_eth_define_is_12G_supported].name = "is_12G_supported";
    submodule_data->defines[dnx_data_nif_eth_define_is_12G_supported].doc = "Marks if 12G speed port is supported for the device";
    
    submodule_data->defines[dnx_data_nif_eth_define_is_12G_supported].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_nif_eth_is_12G_supported_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_nif, dnx_data_nif_submodule_eth, dnx_data_nif_eth_define_is_12G_supported);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_nif_features_toggle_lag_failover_on_link_status_up].name = "toggle_lag_failover_on_link_status_up";
    submodule_data->features[dnx_data_nif_features_toggle_lag_failover_on_link_status_up].doc = "";
    submodule_data->features[dnx_data_nif_features_toggle_lag_failover_on_link_status_up].flags |= DNXC_DATA_F_FEATURE;
