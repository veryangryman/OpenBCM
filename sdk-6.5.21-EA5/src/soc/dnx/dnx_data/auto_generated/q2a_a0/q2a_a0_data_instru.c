...
static shr_error_e
q2a_a0_dnx_data_instru_synced_counters_start_lags_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
...
static shr_error_e
q2a_a0_dnx_data_instru_synced_counters_nif_traffic_not_working_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_instru_synced_counters_start_lags_set;
    data_index = dnx_data_instru_synced_counters_define_nif_traffic_not_working;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_instru_synced_counters_nif_traffic_not_working_set;
