    ...
    int unit)
{
    ...
    if (dnx_mib_counter_rx_fec_16_symbol_error_per_frame < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_16_symbol_error_per_frame, 0);
        data->offset_in_row = 15;
        data->doc = "RX FEC 16 symbol error per frame";
    }
