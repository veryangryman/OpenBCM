...
static shr_error_e
jr2_a0_dnx_data_instru_synced_counters_start_lags_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
    int submodule_index = dnx_data_instru_submodule_synced_counters;
    int define_index = dnx_data_instru_synced_counters_define_start_lags;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_instru_synced_counters_nif_traffic_not_working_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
    int submodule_index = dnx_data_instru_submodule_synced_counters;
    int define_index = dnx_data_instru_synced_counters_define_nif_traffic_not_working;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_instru_synced_counters_shifting_continuous_non_continuous_not_working_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
    int submodule_index = dnx_data_instru_submodule_synced_counters;
    int define_index = dnx_data_instru_synced_counters_define_shifting_continuous_non_continuous_not_working;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_instru_synced_counters_define_start_lags;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_instru_synced_counters_start_lags_set;
    data_index = dnx_data_instru_synced_counters_define_nif_traffic_not_working;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_instru_synced_counters_nif_traffic_not_working_set;
    data_index = dnx_data_instru_synced_counters_define_shifting_continuous_non_continuous_not_working;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_instru_synced_counters_shifting_continuous_non_continuous_not_working_set;
