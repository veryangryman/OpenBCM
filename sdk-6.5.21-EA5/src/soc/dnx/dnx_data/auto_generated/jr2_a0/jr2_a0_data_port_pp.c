...
static shr_error_e
jr2_a0_dnx_data_port_pp_general_rch_removal_port_field_profile_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_port_pp;
    int submodule_index = dnx_data_port_pp_submodule_general;
    int define_index = dnx_data_port_pp_general_define_rch_removal_port_field_profile;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_port_pp_general_rch_extended_encap_port_field_profile_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_port_pp;
    int submodule_index = dnx_data_port_pp_submodule_general;
    int define_index = dnx_data_port_pp_general_define_rch_extended_encap_port_field_profile;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_port_pp_general_define_rch_removal_port_field_profile;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_port_pp_general_rch_removal_port_field_profile_set;
    data_index = dnx_data_port_pp_general_define_rch_extended_encap_port_field_profile;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_port_pp_general_rch_extended_encap_port_field_profile_set;
