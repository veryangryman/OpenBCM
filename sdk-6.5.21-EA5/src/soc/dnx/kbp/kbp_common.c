...
shr_error_e dnx_kbp_caching_enabled_get(int unit, int is_acl, int *enabled){DNX_KBP_DUMMY_PROTOTYPE_ERR_MSG("dnx_kbp_caching_enabled_get")}
shr_error_e dnx_kbp_caching_enabled_set(int unit, int is_acl, int enable){DNX_KBP_DUMMY_PROTOTYPE_ERR_MSG("dnx_kbp_caching_enabled_set")}
