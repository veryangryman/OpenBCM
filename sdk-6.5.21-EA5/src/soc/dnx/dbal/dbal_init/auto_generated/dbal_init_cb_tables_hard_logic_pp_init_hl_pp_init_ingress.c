...
uint32 * offset)
{
    ...
    result_size__forward_domain_mask_profile += dnx_data_aod_sizes.AOD.sizes_get(unit, 222)->value;
...
uint32 * offset)
{
    ...
    result_size__layer_types_speculation += dnx_data_aod_sizes.AOD.sizes_get(unit, 108)->value;
...
uint32 * offset)
{
    ...
    result_size__layer_types_force_incorrect += dnx_data_aod_sizes.AOD.sizes_get(unit, 108)->value;
