...
shr_error_e
sch_flex_quartet_region_mode_flex_quartet_mode_arrayoffset_0_cb(
int unit,
void * entry_handle,
dbal_fields_e current_mapped_field_id,
uint32 * offset)
{
    dbal_entry_handle_t *  eh = (dbal_entry_handle_t *) entry_handle;
    uint32 key_value__flex_quartet_region;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_FLEX_QUARTET_REGION, key_value__flex_quartet_region);
    *offset = key_value__flex_quartet_region*4/32;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
shr_error_e
sch_flex_quartet_region_mode_flex_quartet_mode_dataoffset_0_cb(
int unit,
void * entry_handle,
dbal_fields_e current_mapped_field_id,
uint32 * offset)
