...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_sw_state_set_indirect_table_size(unit, cur_table_param, "PHYDB.INLIF2/DNX_DATA.lif.in_lif.inlif_minimum_index_size" , DBAL_DB_INVALID ));
