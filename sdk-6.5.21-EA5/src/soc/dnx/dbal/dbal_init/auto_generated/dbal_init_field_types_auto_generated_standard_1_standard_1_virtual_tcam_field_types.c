...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    cur_field_types_info->struct_field_info[1].length = dnx_data_mdb_app_db.fields.numeric_mdb_field___216_get(unit);
    cur_field_types_info->struct_field_info[2].struct_field_id = DBAL_FIELD_ZERO_PADDING;
    cur_field_types_info->struct_field_info[2].length = dnx_data_mdb_app_db.fields.numeric_mdb_field___217_get(unit);
