...
uint32 * offset)
{
    ...
    result_size__ptc_routing_enable_profile_vtt1 += dnx_data_aod_sizes.AOD.sizes_get(unit, 185)->value;
    
    result_size__ptc_cs_profile_vtt2 += dnx_data_aod_sizes.AOD.sizes_get(unit, 179)->value;
