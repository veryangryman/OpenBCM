...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    sal_memset(cur_field_type_param->enums, 0x0, cur_field_type_param->nof_enum_vals * sizeof(dbal_db_enum_info_struct_t));
    {
        ...
        sal_strncpy(enum_info->name_from_interface, "FORWARD_DOMAIN_VRF_ENCODING", sizeof(enum_info->name_from_interface));
        enum_info++;
        sal_strncpy(enum_info->name_from_interface, "TTL_IDX_MPLS_FHEI", sizeof(enum_info->name_from_interface));
        enum_info++;
        sal_strncpy(enum_info->name_from_interface, "QOS_MODEL_MPLS_FHEI", sizeof(enum_info->name_from_interface));
        enum_info++;
        sal_strncpy(enum_info->name_from_interface, "QOS_IDX_MPLS_FHEI", sizeof(enum_info->name_from_interface));
        enum_info++;
        sal_strncpy(enum_info->name_from_interface, "TTL_MODEL_MPLS_FHEI", sizeof(enum_info->name_from_interface));
        enum_info++;
    }
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    {
        dbal_db_enum_info_struct_t * enum_info = cur_field_type_param->enums;
        sal_strncpy(enum_info->name_from_interface, "VSI_P2P_MSBS", sizeof(enum_info->name_from_interface));
        enum_info++;
    }
