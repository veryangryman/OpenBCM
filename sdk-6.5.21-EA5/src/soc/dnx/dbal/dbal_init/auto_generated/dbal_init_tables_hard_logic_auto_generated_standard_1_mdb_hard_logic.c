...
dbal_logical_table_t * table_info)
{
    ...
    
    {
        ...
        field_index = 0;
        DBAL_DB_INIT_TABLE_NOF_RESULT_FIELDS_SET(table_entry, (table_entry->multi_res_info[result_type_counter]), 7 + (((dnx_data_mdb_app_db.fields.numeric_mdb_field___0___valid_get(unit))>0)?1:0));
            ...
            
            {
                ...
                
                {
                    ...
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HW_ENTITY_GROUP_EMPTY , regMemHwEntityId , fieldHwEntityId , INVALIDm ));
                    {
                        ...
                        access_params->data_offset.formula_int = 60-result_size__result_type-12-2; 
                    }
                }
            }
        }
            ...
            
            {
                ...
                
                {
                    ...
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HW_ENTITY_GROUP_EMPTY , regMemHwEntityId , fieldHwEntityId , INVALIDm ));
                    {
                        ...
                        access_params->data_offset.formula_int = 60-result_size__result_type-12-2-6; 
                    }
                }
            }
        }
            ...
            
            {
                ...
                
                {
                    ...
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HW_ENTITY_GROUP_EMPTY , regMemHwEntityId , fieldHwEntityId , INVALIDm ));
                    {
                        ...
                        access_params->data_offset.formula_int = 60-result_size__result_type-12-2-6-5; 
                    }
                }
            }
        }
            ...
            
            {
                ...
                
                {
                    ...
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HW_ENTITY_GROUP_EMPTY , regMemHwEntityId , fieldHwEntityId , INVALIDm ));
                    {
                        ...
                        access_params->data_offset.formula_int = 60-result_size__result_type-12-2-6-5-2; 
                    }
                }
            }
        }
            ...
            
            {
                ...
                
                {
                    ...
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HW_ENTITY_GROUP_EMPTY , regMemHwEntityId , fieldHwEntityId , INVALIDm ));
                    {
                        ...
                        access_params->data_offset.formula_int = 60-result_size__result_type-12-2-6-5-2-6; 
                    }
                }
            }
        }
            ...
            
            {
                ...
                
                {
                    ...
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HW_ENTITY_GROUP_EMPTY , regMemHwEntityId , fieldHwEntityId , INVALIDm ));
                    {
                        ...
                        access_params->data_offset.formula_int = 60-result_size__result_type-12-2-6-5-2-6-1; 
                    }
                }
            }
        }
