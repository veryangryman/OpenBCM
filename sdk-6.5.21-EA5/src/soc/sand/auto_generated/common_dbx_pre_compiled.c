...
const char *NetworkHeadersObjects_3="        <condition type=\"field\" mode=\"enable\">\n\
                    <enable val=\"1\" />\n\
                    <field path=\"VXLAN_GPE.GPE_Flags.P\"/>\n\
                </condition>\n\
                <condition type=\"field\" mode=\"enable\">\n\
...
const char *NetworkHeadersObjects_4=" object=\"OAM\"  val=\"5\"/>\n\
    ...
    long int * size_p)
{
    ...
    *size_p = 0;
    ...
    if(!sal_strncmp("NetworkHeadersObjects.xml", filePath, RHFILE_MAX_SIZE))
    {
        ...
        _internal_size_p += sal_strlen(NetworkHeadersObjects_4);
        ...
        *size_p = _internal_size_p;
        ...
        offset += sal_strlen(NetworkHeadersObjects_3);
        sal_strncpy(file_buf + offset, NetworkHeadersObjects_4, sal_strlen(NetworkHeadersObjects_4));
    ...
    {
        _internal_size_p = 0;
        _internal_size_p += sal_strlen(export_export_test_0);

        *size_p = _internal_size_p;
        offset = 0;
        file_buf = sal_alloc(*size_p, "buf");

        sal_strncpy(file_buf, export_export_test_0, sal_strlen(export_export_test_0));
