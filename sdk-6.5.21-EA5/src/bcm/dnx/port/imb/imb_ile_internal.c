...
/**
 * \brief - Set ILE in/out soft init
 */
shr_error_e
imb_ile_blocks_soft_init_enable(
    int unit,
    int ilkn_core_id,
    int enable)
{
     ...
     * alloc DBAL table handle
     */
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_NIF_ILE_BLOCKS_SOFT_INIT, &entry_handle_id));
    /*
     * set key fields
     */
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_ILKN_CORE_ID, ilkn_core_id);
