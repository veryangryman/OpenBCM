    ...
    int enable)
{
    ...
    if (enable)
    {
        ...
        {
            sal_usleep(5000);
            SHR_IF_ERR_EXIT(imb_ile_blocks_soft_init_enable(unit, ilkn_access_info.ilkn_core, 1));
            sal_usleep(5000);
            SHR_IF_ERR_EXIT(imb_ile_blocks_soft_init_enable(unit, ilkn_access_info.ilkn_core, 0));
        }
