    ...
    int recycle_app_type)
{
    ...
    {
        SHR_IF_ERR_EXIT(bcm_dnx_port_class_set(unit, port, bcmPortClassFieldIngressPMF3TrafficManagementPortCs,
                                               dnx_data_port_pp.
                                               general.rch_extended_encap_port_field_profile_get(unit)));
    }
    else if (recycle_app_type == bcmPortControlRecycleAppDefault)
    {
        SHR_IF_ERR_EXIT(bcm_dnx_port_class_set(unit, port, bcmPortClassFieldIngressPMF3TrafficManagementPortCs, 0));
    }
    else
    {
        SHR_IF_ERR_EXIT(bcm_dnx_port_class_set(unit, port, bcmPortClassFieldIngressPMF3TrafficManagementPortCs,
                                               dnx_data_port_pp.general.rch_removal_port_field_profile_get(unit)));
    }
