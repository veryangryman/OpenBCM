    ...
    dbal_tables_e inlif_dbal_table_id)
{
    ...
    int egress_in_lif_profile, hw_write_counter, pmf_reserved_nof_bits, egress_reserved_nof_bits,
        ...
        in_lif_profile_egress_reserved_start_bit, egress_eth_rif_profile, indexed_mode_nof_bits,
    ...
    {
        SHR_IF_ERR_EXIT(dnx_in_lif_profile_table_init
                        (unit, old_in_lif_profile, TRUE, pmf_reserved_nof_bits, egress_reserved_nof_bits,
                         indexed_mode_nof_bits, intf_type));
        SHR_IF_ERR_EXIT(dnx_vsi_profile_table_init
                        (unit, old_in_lif_profile, TRUE, pmf_reserved_nof_bits, egress_reserved_nof_bits, intf_type));
    }
