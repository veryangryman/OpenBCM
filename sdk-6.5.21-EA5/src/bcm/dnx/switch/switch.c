    ...
    int *switch_header_type)
{
    ...
    else
    {
        ...
        {
            SHR_ERR_EXIT(_SHR_E_PARAM,
                         "Direction BOTH (in and out) API is only available for ETH, RAW, INJECTED and MPLS_RAW header types. Other types are non-directional. Please use bcm_switch_control_indexed_port_get API with direction IN or OUT instead. \n");
        }
