    ...
    bcm_instru_ifa_info_t * ifa_info)
{
    ...
    if ((ifa_info->flags & BCM_INSTRU_IFA_ENCAP_REPLACE) != BCM_INSTRU_IFA_ENCAP_REPLACE)
    {
        SHR_IF_ERR_EXIT(dnx_lif_lib_add_to_glem(unit, _SHR_CORE_ALL, global_lif_info.global_lif, local_out_lif));
    }
    ...
    int unit)
{
     ...
     */
    SHR_INVOKE_VERIFY_DNX(dnx_instru_synced_counters_time_ratio_init(unit));
