    ...
    dnx_algo_local_outlif_hw_info_t * outlif_hw_info)
{
    ...
    if (allocate_global_lif)
    {
         ...
         */
        /** TBD this function is called twice, once from this layer and once from dnx_algo_global_lif_allocation_allocate  */
        SHR_INVOKE_VERIFY_DNX(dnx_algo_global_lif_allocation_verify
                              (unit, global_lif_allocation_flags, global_lif_direction_flags, NULL, global_lif_tmp));
    }
