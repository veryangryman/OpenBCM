    ...
    bcm_field_entry_info_t * entry_info)
{
    ...
    switch (fg_type)
    {
        case DNX_FIELD_GROUP_TYPE_STATE_TABLE:
        {
            uint32 address = DNX_FIELD_STATE_TABLE_ENTRY_ADDRESS(dnx_entry_handle);
            dnx_entry_info.core = DNX_FIELD_TCAM_ENTRY_CORE_ID(dnx_entry_handle);
    ...
    bcm_field_entry_t entry_handle)
{
    ...
    switch (fg_type)
    {
        ...
        case DNX_FIELD_GROUP_TYPE_STATE_TABLE:
        {
            int core = DNX_FIELD_TCAM_ENTRY_CORE_ID(dnx_entry_handle);
            uint32 address = DNX_FIELD_STATE_TABLE_ENTRY_ADDRESS(dnx_entry_handle);
