...
} dnx_bfd_oamp_v1_only_endpoint_t;
...
} dnx_bfd_oamp_v1_only_temp_mep_db_data_t;
...
} dnx_bfd_oamp_v1_only_temp_db_delete_data_t;
 ...
 *   * None
 */
shr_error_e dnx_bfd_oamp_v1_only_endpoint_db_build_param_for_mep_db(
    int unit,
 ...
 *   * None
 */
shr_error_e dnx_bfd_pwe_with_lm_dm_verify(
    int unit,
 ...
 *   * None
 */
shr_error_e dnx_bfd_oamp_v1_only_build_endpoint_id(
    int unit,
 ...
 *   * None
 */
shr_error_e dnx_bfd_oamp_v1_only_mep_db_endpoint_clear(
    int unit,
    uint16 oam_id,
    uint8 is_ipv6);
 ...
 *   * None
 */
shr_error_e dnx_bfd_oamp_v1_only_mep_db_endpoint_get(
    int unit,
    uint16 oam_id,
    dnx_bfd_oamp_v1_only_endpoint_t * entry_values);
 ...
 *   * None
 */
shr_error_e dnx_bfd_oamp_v1_only_write_data_to_templates(
    int unit,
    const bcm_bfd_endpoint_info_t * endpoint_info,
 ...
 *   * None
 */
shr_error_e dnx_bfd_oamp_v1_only_modify_data_in_templates(
    int unit,
 ...
 *   * None
 */
shr_error_e dnx_bfd_oamp_v1_only_endpoint_db_write_to_hw(
    int unit,
    const dnx_bfd_oamp_v1_only_temp_mep_db_data_t * mep_hw_write_data,
 ...
 *   * None
 */
shr_error_e dnx_bfd_oamp_v1_only_endpoint_db_delete_from_hw(
    int unit,
    const dnx_bfd_oamp_v1_only_endpoint_t * mep_entry_values,
    const dnx_oam_oamp_rmep_db_entry_t * rmep_entry_values,
    dnx_bfd_oamp_v1_only_temp_db_delete_data_t * oamp_hw_delete_data,
 ...
 *   * None
 */
shr_error_e dnx_bfd_oamp_v1_only_read_data_from_templates(
    int unit,
    bcm_bfd_endpoint_info_t * endpoint_info,
 ...
 *   * None
 */
shr_error_e dnx_bfd_oamp_v1_only_mep_db_endpoint_set(
    int unit,
    const bcm_bfd_endpoint_info_t * endpoint_info,
    dnx_bfd_oamp_v1_only_endpoint_t * entry_values);
 ...
 *   * None
 */
shr_error_e dnx_bfd_oamp_v1_only_short_entry_type_verify(
    int unit,
    uint16 oam_id,
    const bcm_bfd_endpoint_info_t * endpoint_info);
...
*   * None
*/
shr_error_e dnx_bfd_oamp_v1_only_endpoint_without_mpls_lm_dm(
    int unit,
 ...
 *   * None
 */
shr_error_e dnx_bfd_oamp_v1_only_delete_data_from_templates(
    int unit,
 ...
 *   * None
 */
shr_error_e dnx_bfd_oamp_v1_only_set_mpls_lm_dm_mep_profile(
    int unit,
    bcm_bfd_endpoint_t endpoint,
    uint8 new_profile);
 ...
 *   * None
 */
void dnx_bfd_oamp_v1_only_endpoint_db_analyze_param_from_oamp_mep_db(
    int unit,
    bcm_bfd_endpoint_info_t * endpoint_info,
