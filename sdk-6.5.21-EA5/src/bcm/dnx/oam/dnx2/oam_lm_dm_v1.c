...
#include <src/bcm/dnx/oam/dnx2/oam_oamp_v1.h>
    ...
    uint32 *tx_rate_profile)
{
    ...
    dnx_bfd_oamp_v1_only_temp_mep_db_data_t *mep_hw_write_data = NULL;
    uint8 write_hw = FALSE, tx_rate_write_delete = FALSE;
    uint32 old_tx_profile;
    SHR_FUNC_INIT_VARS(unit);

    SHR_ALLOC_SET_ZERO(mep_hw_write_data, sizeof(dnx_bfd_oamp_v1_only_temp_mep_db_data_t),
...
/* { */
        ...
        SHR_IF_ERR_EXIT(dnx_oam_oamp_scan_count_calc_rfc_6374_lm_dm(unit, endpoint_id, 0 /** free the pase */ ,
                                                                    OAMP_MEP_TX_OPCODE_LMM, mep_profile_data));
/* } */
#endif
    }
 ...
 */
shr_error_e
dnx_oam_oamp_v1_onlys_loss_add(
    int unit,
    bcm_oam_loss_t * loss_ptr)
{
 ...
 */
shr_error_e
dnx_oam_oamp_v1_onlys_loss_get(
    int unit,
    bcm_oam_loss_t * loss_ptr)
{
    bcm_oam_endpoint_info_t endpoint_info;
...
/* } */
    ...
    if ((loss_ptr->pkt_pri_bitmap != 0xff) && (loss_ptr->pkt_pri_bitmap != 0))
    {
        if (piggy_back_lm)
        {
            SHR_IF_ERR_EXIT(dnx_oamp_mep_db_ccm_endpoint_get(unit, mep_id, 0, ccm_mep_db_entry_o));
 ...
 */
shr_error_e
dnx_oam_oamp_v1_onlys_loss_delete(
    int unit,
    bcm_oam_loss_t * loss_ptr)
{
    bcm_oam_endpoint_info_t endpoint_info;
...
/* { */
        ...
        SHR_IF_ERR_EXIT(dnx_oam_mpls_lm_dm_without_bfd_endpoint
                        (unit, endpoint_id, &is_mpls_lm_dm_without_bfd_endpoint));
        SHR_IF_ERR_EXIT(dnx_oam_oamp_scan_count_calc_rfc_6374_lm_dm(unit, endpoint_id, 0 /** free the phase */ ,
                                                                    OAMP_MEP_TX_OPCODE_DMM, mep_profile_data));
/* } */
#endif
    }
 ...
 */
shr_error_e
dnx_oam_oamp_v1_onlys_delay_add(
    int unit,
 ...
 */
shr_error_e
dnx_oam_oamp_v1_onlys_delay_get(
    int unit,
    bcm_oam_delay_t * delay_ptr)
{
    uint32 oam_id, session_oam_id;
 ...
 */
shr_error_e
dnx_oam_oamp_v1_onlys_delay_delete(
    int unit,
    bcm_oam_delay_t * delay_ptr)
{
    bcm_oam_endpoint_info_t endpoint_info;
