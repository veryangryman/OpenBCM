...
#define DNX_BFD_OAMP_V1_ONLY_IPV6_FLOW_LABEL_NOF_BITS 20

/** IPv6 version number */
#define DNX_BFD_OAMP_V1_ONLY_IPV6_VERSION 6

/** number of bits of the diag field in BFD header */
#define DNX_BFD_OAMP_V1_ONLY_BFD_DIAG_NOF_BITS 5
...
/** UDP BFD port */
#define DNX_BFD_OAMP_V1_ONLY_BFD_UDP_PORT(flags) (!_SHR_IS_FLAG_SET(flags, BCM_BFD_ENDPOINT_MULTIHOP)) ? \
        ((_SHR_IS_FLAG_SET(flags, BCM_BFD_ENDPOINT_MICRO_BFD)) ? 6784 : 3784) : 4784

/** number of bits of the flags field in BFD header */
#define DNX_BFD_OAMP_V1_ONLY_BFD_FLAGS_NOF_BITS 6
...
#define DNX_BFD_OAMP_V1_ONLY_EXTRA_DATA_HEADER_OPCODES_TO_PREPEND_NOF_BITS 14

/** UDP opcode */
#define DNX_BFD_OAMP_V1_ONLY_UDP_OPCODE 17

/** number of bits of the flow label field in IPv6 header */
#define DNX_BFD_OAMP_V1_ONLY_IPV6_FLOW_LABEL_NOF_BITS 20

/** number of bits of the priority field in IPv6 header */
#define DNX_BFD_OAMP_V1_ONLY_IPV6_PRIORITY_NOF_BITS 8
    ...
    const bcm_bfd_endpoint_info_t * bfd_endpoint_info)
{
    ...
    SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_endpoint_without_mpls_lm_dm
...
*/
shr_error_e
dnx_bfd_oamp_v1_only_endpoint_without_mpls_lm_dm(
    int unit,
 ...
 */
shr_error_e
dnx_bfd_oamp_v1_only_endpoint_db_build_param_for_mep_db(
    int unit,
    const bcm_bfd_endpoint_info_t * endpoint_info,
    const dnx_bfd_oamp_v1_only_temp_mep_db_data_t * mep_hw_write_data,
    const uint32 bfd_sw_state_flags,
    dnx_bfd_oamp_v1_only_endpoint_t * entry_values)
{
 ...
 */
shr_error_e
dnx_bfd_oamp_v1_only_short_entry_type_verify(
    int unit,
    uint16 oam_id,
    const bcm_bfd_endpoint_info_t * endpoint_info)
{
 ...
 */
shr_error_e
dnx_bfd_oamp_v1_only_set_mpls_lm_dm_mep_profile(
    int unit,
 ...
 */
shr_error_e
dnx_bfd_oamp_v1_only_mep_db_endpoint_get(
    int unit,
    uint16 oam_id,
    dnx_bfd_oamp_v1_only_endpoint_t * entry_values)
{
 ...
 */
static void
dnx_bfd_oamp_v1_only_tx_period_cluster_get_mep_profile_field(
    int unit,
    int endpoint_id,
    uint8 is_ipv6,
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_only_delete_oamp_cluster_mep_profiles(
    int unit,
    bcm_bfd_endpoint_t endpoint,
    uint8 cluster_profile,
    uint8 ipv6_flag,
    dnx_bfd_oamp_v1_only_temp_db_delete_data_t * oamp_hw_delete_data)
{
    ...
    dnx_bfd_oamp_v1_only_tx_period_cluster_get_mep_profile_field(unit, endpoint, ipv6_flag, &mep_profile_field,
 ...
 */
shr_error_e
dnx_bfd_oamp_v1_only_delete_data_from_templates(
    int unit,
    bcm_bfd_endpoint_t endpoint,
    const dnx_bfd_oamp_v1_only_endpoint_t * mep_entry_values,
    ...
    int is_single_hop_with_random_dip)
{
    ...
    if (tx_rate_data.cluster_profile != 0xFF)
    {
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_delete_oamp_cluster_mep_profiles
 ...
 */
shr_error_e
dnx_bfd_oamp_v1_only_build_endpoint_id(
    int unit,
    ...
    bfd_temp_endpoint_data_t * hw_write_data)
{
    ...
    dnx_bfd_oamp_v1_only_endpoint_t *mep_entry_values = NULL;
    ...
    if (ENDPOINT_FROM_OAMP(endpoint_info))
    {
        ...
        if (mep_db_lim == 1)
        {
            SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_short_entry_type_verify(unit, lif_id, endpoint_info));
        }
            ...
            if (!BFD_TYPE_NOT_PWE(endpoint_info->type))
            {
                ...
                if (is_alloc)
                {
                    ...
                    if (DNX_OAM_IS_ENDPOINT_RFC6374(oam_sw_state_info))
                    {
                        ...
                        SHR_ALLOC_SET_ZERO(mep_entry_values, sizeof(dnx_bfd_oamp_v1_only_endpoint_t),
                                           "Structure used to call OAMP MEP DB get", "%s%s%s\r\n", EMPTY, EMPTY, EMPTY);
                        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_mep_db_endpoint_get(unit, oam_id, mep_entry_values));
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_only_single_hop_tos_sw_update(
    int unit,
    const bcm_bfd_endpoint_info_t * endpoint_info,
    dnx_bfd_oamp_v1_only_temp_mep_db_data_t * mep_hw_write_data)
{
    shr_error_e rv;
    int dummy;
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_only_local_min_echo_sw_update(
    int unit,
    const bcm_bfd_endpoint_info_t * endpoint_info,
    dnx_bfd_oamp_v1_only_temp_mep_db_data_t * mep_hw_write_data)
{
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_only_discriminator_start_update(
    int unit,
    const bcm_bfd_endpoint_info_t * endpoint_info,
    dnx_bfd_oamp_v1_only_temp_mep_db_data_t * mep_hw_write_data)
{
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_only_udp_src_port_profile_sw_update(
    int unit,
    const bcm_bfd_endpoint_info_t * endpoint_info,
    dnx_bfd_oamp_v1_only_temp_mep_db_data_t * mep_hw_write_data)
{
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_only_itmh_priority_profile_sw_update(
    int unit,
    const bcm_bfd_endpoint_info_t * endpoint_info,
    dnx_bfd_oamp_v1_only_temp_mep_db_data_t * mep_hw_write_data)
{
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_only_system_port_profile_sw_update(
    int unit,
    const bcm_bfd_endpoint_info_t * endpoint_info,
    dnx_bfd_oamp_v1_only_temp_mep_db_data_t * mep_hw_write_data)
{
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_only_tx_rate_profile_sw_update(
    int unit,
    const bcm_bfd_endpoint_info_t * endpoint_info,
    dnx_bfd_oamp_v1_only_temp_mep_db_data_t * mep_hw_write_data,
    uint8 current_profile)
{
    ...
    SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_endpoint_without_mpls_lm_dm
                    (unit, endpoint_info->id, &is_bfd_without_mpls_lm_dm));
    ...
    if (endpoint_info->bfd_period == 0)
    {
         ...
         *  will not be transmitted.  See also dnx_bfd_oamp_v1_only_mep_profile_sw_update.
         */
        new_tx_rate = 0;
    }
    else
    ...
    dnx_bfd_oamp_v1_only_tx_period_cluster_get_mep_profile_field(unit, endpoint_info->id,
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_only_ipv4_src_addr_profile_sw_update(
    int unit,
    const bcm_bfd_endpoint_info_t * endpoint_info,
    dnx_bfd_oamp_v1_only_temp_mep_db_data_t * mep_hw_write_data)
{
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_only_tos_ttl_profile_sw_update(
    int unit,
    const bcm_bfd_endpoint_info_t * endpoint_info,
    dnx_bfd_oamp_v1_only_temp_mep_db_data_t * mep_hw_write_data)
{
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_only_mpls_pwe_ttl_exp_profile_sw_update(
    int unit,
    const bcm_bfd_endpoint_info_t * endpoint_info,
    dnx_bfd_oamp_v1_only_temp_mep_db_data_t * mep_hw_write_data)
{
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_only_req_int_profile_sw_update(
    int unit,
    const bcm_bfd_endpoint_info_t * endpoint_info,
    dnx_bfd_oamp_v1_only_temp_mep_db_data_t * mep_hw_write_data)
{
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_only_delete_cluster_mep_profiles(
    int unit,
    bcm_bfd_endpoint_t endpoint,
    uint8 cluster_profile,
    uint8 ipv6_flag,
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_only_local_min_echo_sw_read(
    int unit,
    bcm_bfd_endpoint_info_t * endpoint_info,
    const dnx_bfd_oamp_v1_only_temp_mep_db_data_t * mep_sw_read_data)
{
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_only_single_hop_tos_sw_read(
    int unit,
    bcm_bfd_endpoint_info_t * endpoint_info,
    const dnx_bfd_oamp_v1_only_temp_mep_db_data_t * mep_sw_read_data)
{
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_only_udp_src_port_profile_sw_read(
    int unit,
    bcm_bfd_endpoint_info_t * endpoint_info)
{
    int dummy;
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_only_punt_profile_sw_read(
    int unit,
    bcm_bfd_endpoint_info_t * endpoint_info,
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_only_mpls_pwe_ttl_exp_profile_sw_read(
    int unit,
    bcm_bfd_endpoint_info_t * endpoint_info,
    const dnx_bfd_oamp_v1_only_temp_mep_db_data_t * mep_sw_read_data)
{
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_only_itmh_priority_profile_sw_read(
    int unit,
    bcm_bfd_endpoint_info_t * endpoint_info,
    const dnx_bfd_oamp_v1_only_temp_mep_db_data_t * mep_sw_read_data)
{
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_only_tx_rate_profile_sw_read(
    int unit,
    bcm_bfd_endpoint_info_t * endpoint_info,
    const dnx_bfd_oamp_v1_only_temp_mep_db_data_t * mep_sw_read_data)
{
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_only_req_int_profile_sw_read(
    int unit,
    bcm_bfd_endpoint_info_t * endpoint_info,
    const dnx_bfd_oamp_v1_only_temp_mep_db_data_t * mep_sw_read_data)
{
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_only_tos_ttl_profile_sw_read(
    int unit,
    bcm_bfd_endpoint_info_t * endpoint_info,
    const dnx_bfd_oamp_v1_only_temp_mep_db_data_t * mep_sw_read_data)
{
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_only_ipv4_src_addr_profile_sw_read(
    int unit,
    bcm_bfd_endpoint_info_t * endpoint_info,
    const dnx_bfd_oamp_v1_only_temp_mep_db_data_t * mep_sw_read_data)
{
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_only_system_port_profile_sw_read(
    int unit,
    bcm_bfd_endpoint_info_t * endpoint_info,
    const dnx_bfd_oamp_v1_only_temp_mep_db_data_t * mep_sw_read_data)
{
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_only_punt_profile_sw_update(
    int unit,
    const bcm_bfd_endpoint_info_t * endpoint_info,
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_only_mep_profile_sw_update(
    int unit,
    const bcm_bfd_endpoint_info_t * endpoint_info,
    dnx_bfd_oamp_v1_only_temp_mep_db_data_t * mep_hw_write_data)
{
    ...
    if (endpoint_info->bfd_period == 0)
    {
         ...
         *  Packets from the endpoint are sent at the maximum rate.  To overcome this, scan
         *  profile is set to 1, and since count==1 never happens at maximum rate, packets
         *  will not be transmitted.  See also dnx_bfd_oamp_v1_only_tx_rate_profile_sw_update.
         */
        if (tx_rate_data.cluster_profile != 0xFF)
        {
            /**
 ...
 */
void
dnx_bfd_oamp_v1_only_endpoint_db_analyze_param_from_oamp_mep_db(
    int unit,
    bcm_bfd_endpoint_info_t * endpoint_info,
    dnx_bfd_oamp_v1_only_temp_mep_db_data_t * mep_sw_read_data,
    const dnx_bfd_oamp_v1_only_endpoint_t * entry_values)
{
    int dummy;
 ...
 */
shr_error_e
dnx_bfd_oamp_v1_only_write_data_to_templates(
    int unit,
    const bcm_bfd_endpoint_info_t * endpoint_info,
    dnx_bfd_oamp_v1_only_temp_mep_db_data_t * mep_hw_write_data,
    bfd_temp_oamp_rmep_db_data_t * rmep_hw_write_data)
{
    ...
    SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_itmh_priority_profile_sw_update(unit, endpoint_info, mep_hw_write_data));

    /** System port profile */
    if (!BCM_L3_ITF_TYPE_IS_FEC(endpoint_info->egress_if))
    {
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_system_port_profile_sw_update(unit, endpoint_info, mep_hw_write_data));
    }
    ...
    SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_tx_rate_profile_sw_update(unit, endpoint_info, mep_hw_write_data, 0xFF));
    ...
    if (BFD_TYPE_NOT_PWE(endpoint_info->type))
    {
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_ipv4_src_addr_profile_sw_update(unit, endpoint_info, mep_hw_write_data));
    }
    ...
    {
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_tos_ttl_profile_sw_update(unit, endpoint_info, mep_hw_write_data));
    }
    ...
    if (SINGLE_HOP_U_BFD_TOS_SUPPORTED(unit) &&
        ...
        !_SHR_IS_FLAG_SET(endpoint_info->flags2, BCM_BFD_ENDPOINT_FLAGS2_SEAMLESS_BFD_INITIATOR))
    {
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_single_hop_tos_sw_update(unit, endpoint_info, mep_hw_write_data));
    }
        ...
        && (!_SHR_IS_FLAG_SET(endpoint_info->flags2, BCM_BFD_ENDPOINT_FLAGS2_SINGLE_HOP_WITH_RANDOM_DIP)))
    {
        ...
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_mpls_pwe_ttl_exp_profile_sw_update
                        (unit, endpoint_info, mep_hw_write_data));
    }
    ...
    if (BFD_TYPE_NOT_PWE(endpoint_info->type))
    {
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_udp_src_port_profile_sw_update(unit, endpoint_info, mep_hw_write_data));
    }
    ...
    SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_req_int_profile_sw_update(unit, endpoint_info, mep_hw_write_data));

    /** Adjust my discriminator range start if necessary */
    SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_discriminator_start_update(unit, endpoint_info, mep_hw_write_data));

    /** Adjust local minimum echo interval if necessary */
    SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_local_min_echo_sw_update(unit, endpoint_info, mep_hw_write_data));

    /** End of BFD PDU relevant templates */

    /** Punt profile - used for reception only */
    SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_punt_profile_sw_update(unit, endpoint_info, rmep_hw_write_data));
     ...
     */
    SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_mep_profile_sw_update(unit, endpoint_info, mep_hw_write_data));
 ...
 */
shr_error_e
dnx_bfd_oamp_v1_only_modify_data_in_templates(
    int unit,
    ...
    bfd_temp_oamp_rmep_db_data_t * rmep_hw_write_data)
{
    ...
    if (new_endpoint_info->int_pri != existing_endpoint_info->int_pri)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_itmh_priority_profile_sw_update
                        (unit, new_endpoint_info, mep_hw_write_data));
    ...
    if (new_endpoint_info->tx_gport != existing_endpoint_info->tx_gport)
    {
        ...
        {
            SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_system_port_profile_sw_update
                            (unit, new_endpoint_info, mep_hw_write_data));
        }
         ...
         BCM_OAMP_SW_ENTRY_INFO_PERIOD_TO_MEP_DB_SCAN_RATE(existing_endpoint_info->bfd_period)))
    {
        ...
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_tx_rate_profile_sw_update(unit, new_endpoint_info,
                                                                       mep_hw_write_data,
        ...
        || (existing_endpoint_info->flags2 != new_endpoint_info->flags2))
    {
         ...
         */
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_mep_profile_sw_update(unit, new_endpoint_info, mep_hw_write_data));
        ...
        (new_endpoint_info->src_ip_addr != existing_endpoint_info->src_ip_addr))
    {
        ...
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_ipv4_src_addr_profile_sw_update
                        (unit, new_endpoint_info, mep_hw_write_data));
         ...
         (new_endpoint_info->ip_ttl != existing_endpoint_info->ip_ttl)))
    {
        ...
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_tos_ttl_profile_sw_update(unit, new_endpoint_info, mep_hw_write_data));
        ...
        (new_endpoint_info->local_min_tx != existing_endpoint_info->local_min_tx))
    {
        ...
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_req_int_profile_sw_update(unit, new_endpoint_info, mep_hw_write_data));
        ...
        ((new_endpoint_info->flags & PUNT_PROFILE_FLAGS) != (existing_endpoint_info->flags & PUNT_PROFILE_FLAGS)))
    {
        ...
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_punt_profile_sw_update(unit, new_endpoint_info, rmep_hw_write_data));
 ...
 */
shr_error_e
dnx_bfd_oamp_v1_only_endpoint_db_write_to_hw(
    int unit,
    const dnx_bfd_oamp_v1_only_temp_mep_db_data_t * mep_hw_write_data,
 ...
 */
shr_error_e
dnx_bfd_oamp_v1_only_read_data_from_templates(
    int unit,
    bcm_bfd_endpoint_info_t * endpoint_info,
    const dnx_bfd_oamp_v1_only_temp_mep_db_data_t * mep_sw_read_data,
    const bfd_temp_oamp_rmep_db_data_t * rmep_sw_read_data)
{
    ...
    SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_itmh_priority_profile_sw_read(unit, endpoint_info, mep_sw_read_data));

    if (!BCM_L3_ITF_TYPE_IS_FEC(endpoint_info->egress_if))
    {
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_system_port_profile_sw_read(unit, endpoint_info, mep_sw_read_data));
    }
    else
    {
    ...
    SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_tx_rate_profile_sw_read(unit, endpoint_info, mep_sw_read_data));

    if (BFD_TYPE_NOT_PWE(endpoint_info->type))
    {
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_ipv4_src_addr_profile_sw_read(unit, endpoint_info, mep_sw_read_data));
    }
    ...
    {
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_tos_ttl_profile_sw_read(unit, endpoint_info, mep_sw_read_data));
    }

    if (endpoint_info->type != bcmBFDTunnelTypeUdp)
    {
        /** Only one supported type is not MPLS/PWE   */
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_mpls_pwe_ttl_exp_profile_sw_read(unit, endpoint_info, mep_sw_read_data));
    }

    if (BFD_TYPE_NOT_PWE(endpoint_info->type))
    {
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_udp_src_port_profile_sw_read(unit, endpoint_info));
    }

    SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_req_int_profile_sw_read(unit, endpoint_info, mep_sw_read_data));

    SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_punt_profile_sw_read(unit, endpoint_info, rmep_sw_read_data));
    ...
    if (SINGLE_HOP_U_BFD_TOS_SUPPORTED(unit) &&
        ...
        (!_SHR_IS_FLAG_SET(endpoint_info->flags, BCM_BFD_ENDPOINT_MULTIHOP) &&
         !_SHR_IS_FLAG_SET(endpoint_info->flags2, BCM_BFD_ENDPOINT_FLAGS2_SEAMLESS_BFD_INITIATOR)))
    {
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_single_hop_tos_sw_read(unit, endpoint_info, mep_sw_read_data));
    }
    ...
    SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_local_min_echo_sw_read(unit, endpoint_info, mep_sw_read_data));
 ...
 */
shr_error_e
dnx_bfd_oamp_v1_only_endpoint_db_delete_from_hw(
    int unit,
    const dnx_bfd_oamp_v1_only_endpoint_t * mep_entry_values,
    const dnx_oam_oamp_rmep_db_entry_t * rmep_entry_values,
    dnx_bfd_oamp_v1_only_temp_db_delete_data_t * oamp_hw_delete_data,
    ...
    int is_single_hop_with_random_dip)
{
    ...
    if (tx_rate_data.cluster_profile != 0xFF)
    {
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_delete_cluster_mep_profiles(unit, endpoint, tx_rate_data.cluster_profile,
...
static void
dnx_bfd_oamp_v1_only_ipv6_pseduo_header_to_array_of_bytes(
    uint8 *target_array,
...
static void
dnx_bfd_oamp_v1_only_ipv6_header_to_array_of_bytes(
    uint8 *target_array,
...
static void
dnx_bfd_oamp_v1_only_udp_header_to_array_of_bytes(
    uint8 *target_array,
...
static void
dnx_bfd_oamp_v1_only_bfd_header_to_array_of_bytes(
    uint8 *target_array,
 ...
 */
static uint16
dnx_bfd_oamp_v1_only_ones_comp_checksum(
    uint16 *buff,
    uint32 size)
{
    uint32 sum = 0;
...
static shr_error_e
dnx_oamp_v1_only_mep_db_extra_data_clear(
    int unit,
    uint32 entry_id)
{
...
static int
dnx_bfd_oamp_v1_only_udp_over_ipv6_external_data(
    int unit,
    uint16 oam_id,
    ...
    uint8 *ipv6_extra_data_header)
{
    ...
    ipv6_header->version_prior_flow_label =
        bcm_htonl((DNX_BFD_OAMP_V1_ONLY_IPV6_VERSION <<
                   (DNX_BFD_OAMP_V1_ONLY_IPV6_PRIORITY_NOF_BITS + DNX_BFD_OAMP_V1_ONLY_IPV6_FLOW_LABEL_NOF_BITS)) +
                  ((ipv6_prior & ((1 << DNX_BFD_OAMP_V1_ONLY_IPV6_PRIORITY_NOF_BITS) - 1)) <<
                   DNX_BFD_OAMP_V1_ONLY_IPV6_FLOW_LABEL_NOF_BITS));
    ipv6_header->payload_length = bcm_htons((uint16) (DNX_BFD_UDP_HEADER_SIZE + DNX_BFD_BFD_HEADER_SIZE));

    ipv6_header->next_header = DNX_BFD_OAMP_V1_ONLY_UDP_OPCODE;
    ...
    dnx_bfd_oamp_v1_only_ipv6_header_to_array_of_bytes(ipv6_header_packed, ipv6_header);
    dnx_bfd_oamp_v1_only_ipv6_pseduo_header_to_array_of_bytes(ipv6_pseudo_header_packed, ipv6_pseudo_header);
    ...
    {
        udp_dst_port = DNX_BFD_OAMP_V1_ONLY_BFD_UDP_PORT(endpoint_info->flags);
    }
    udp_header->destination_port = bcm_htons(udp_dst_port);
    udp_header->length = ipv6_header->payload_length;

    dnx_bfd_oamp_v1_only_udp_header_to_array_of_bytes(udp_header_packed, udp_header);
    /*
    ...
    bfd_header->vers_diag =
        ((bfd_vers & ((1 << DNX_BFD_OAMP_V1_BFD_VERSION_NOF_BITS) - 1)) << DNX_BFD_OAMP_V1_ONLY_BFD_DIAG_NOF_BITS) +
        endpoint_info->local_diag;
    bfd_header->sta_flags =
        (endpoint_info->local_state << DNX_BFD_OAMP_V1_ONLY_BFD_FLAGS_NOF_BITS) + endpoint_info->local_flags;
    ...
    dnx_bfd_oamp_v1_only_bfd_header_to_array_of_bytes(bfd_header_packed, bfd_header);
    ...
    /*
     * update the checksum field. for more information see dnx_bfd_oamp_v1_only_ones_comp_checksum
     */
    udp_header->checksum =
        bcm_htons(dnx_bfd_oamp_v1_only_ones_comp_checksum((uint16 *) checksum_header_packed,
...
static shr_error_e
dnx_oamp_v1_only_mep_db_extra_data_ipv6_set(
    int unit,
    uint32 mep_id,
    uint8 *data,
    uint16 crc,
    uint8 is_update)
{
    ...
    SHR_IF_ERR_EXIT(dnx_oamp_mep_db_extra_data_set(unit,
                                                   ...
                                                   data,
                                                   (1 <<
                                                    DNX_BFD_OAMP_V1_ONLY_EXTRA_DATA_HEADER_OPCODES_TO_PREPEND_NOF_BITS)
                                                   - 1, crc, 0, is_update));
exit:
    SHR_FUNC_EXIT;
}
 ...
 */
shr_error_e
dnx_bfd_oamp_v1_only_mep_db_endpoint_clear(
    int unit,
    uint16 oam_id,
    uint8 is_ipv6)
{
    dnx_bfd_oamp_v1_only_endpoint_t *entry_values = NULL;

    SHR_FUNC_INIT_VARS(unit);
    DBAL_FUNC_INIT_VARS(unit);

    SHR_ALLOC_SET_ZERO(entry_values, sizeof(dnx_bfd_oamp_v1_only_endpoint_t),
    ...
    SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_mep_db_endpoint_get(unit, oam_id, entry_values));

    if (is_ipv6 && !_SHR_IS_FLAG_SET(entry_values->flags, DNX_OAMP_BFD_MEP_Q_ENTRY))
    {
        SHR_IF_ERR_EXIT(dnx_oamp_v1_only_mep_db_extra_data_clear(unit, entry_values->ipv6_extra_data_index));
    }
 ...
 */
shr_error_e
dnx_bfd_oamp_v1_only_mep_db_endpoint_set(
    int unit,
    const bcm_bfd_endpoint_info_t * endpoint_info,
    dnx_bfd_oamp_v1_only_endpoint_t * entry_values)
{
 ...
 */
    ...
    if (_SHR_IS_FLAG_SET(entry_values->flags, DNX_OAMP_BFD_MEP_Q_ENTRY) == 1)
    {
        ...
        if (_SHR_IS_FLAG_SET(entry_values->flags, DNX_OAMP_BFD_IPV6))
        {
            ...
            dnx_bfd_oamp_v1_only_udp_over_ipv6_external_data(unit, endpoint_info->id, endpoint_info,
            ...
            dnx_oamp_mdb_extra_data_set(unit, endpoint_info->id, 0 /* not offloaded */ , 1 /* 1/4 entry */ ,
                                        calculated_crc,
                                        (1 << DNX_BFD_OAMP_V1_ONLY_EXTRA_DATA_HEADER_OPCODES_TO_PREPEND_NOF_BITS) - 1,
                                        DNX_BFD_IPV6_HEADER_SIZE * UTILEX_NOF_BITS_IN_BYTE,
                                        ipv6_extra_data_header,
        ...
        && !_SHR_IS_FLAG_SET(entry_values->flags, DNX_OAMP_BFD_MEP_Q_ENTRY))
    {
        ...
        SHR_IF_ERR_EXIT(dnx_oamp_v1_only_mep_db_extra_data_ipv6_set(unit, entry_values->ipv6_extra_data_index,
    ...
    if (_SHR_IS_FLAG_SET(entry_values->flags, DNX_OAMP_BFD_MEP_UPDATE)
        && _SHR_IS_FLAG_SET(entry_values->flags, DNX_OAMP_BFD_IPV6))
    {
        SHR_IF_ERR_EXIT(dnx_oamp_v1_only_mep_db_extra_data_ipv6_set
