...
#define DNX_OAMP_IS_V2_ONLY(unit) (dnx_data_oam.oamp.feature_get(unit, dnx_data_oam_oamp_oamp_v2) == 1)
/* Indicate if OAMP v1 is supported. */
#define DNX_OAMP_IS_V1_ONLY(unit) (dnx_data_oam.oamp.feature_get(unit, dnx_data_oam_oamp_oamp_v2) == 0)
