...
/* { */
#include <src/bcm/dnx/oam/dnx2/oam_endpoint_v1.h>
    ...
    bcm_oam_endpoint_info_t * endpoint_info)
{
    ...
    else
    {
        ...
        {
#ifdef BCM_DNX2_SUPPORT
            SHR_IF_ERR_EXIT(dnx_oam_endpoint_fill_id_v1
...
#ifdef BCM_DNX2_SUPPORT
/* { */
            SHR_IF_ERR_EXIT(dnx_oam_oamp_ccm_endpoint_mep_db_create_v1(unit,
