...
#ifdef BCM_DNX2_SUPPORT
/* { */
        SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_onlys_loss_add(unit, loss_ptr));
/* } */
#endif
    }
...
#ifdef BCM_DNX2_SUPPORT
/* { */
        SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_onlys_loss_get(unit, loss_ptr));
/* } */
#endif
    }
...
#ifdef BCM_DNX2_SUPPORT
/* { */
        SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_onlys_loss_delete(unit, loss_ptr));
/* } */
#endif
    }
...
#ifdef BCM_DNX2_SUPPORT
/* { */
        SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_onlys_delay_add(unit, delay_ptr));
/* } */
#endif
    }
...
#ifdef BCM_DNX2_SUPPORT
/* { */
        SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_onlys_delay_get(unit, delay_ptr));
/* } */
#endif
    }
...
#ifdef BCM_DNX2_SUPPORT
/* { */
        SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_onlys_delay_delete(unit, delay_ptr));
/* } */
#endif
    }
