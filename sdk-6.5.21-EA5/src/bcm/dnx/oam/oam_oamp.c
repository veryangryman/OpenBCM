...
static shr_error_e
dnx_oam_oamp_get_existing_scan_rate_for_opcode(
    int unit,
    uint32 mep_id,
    dnx_oam_oamp_tx_opcode opcode,
    const dnx_oam_mep_profile_t * mep_profile_data,
    uint32 *scan_cnt)
{
    ...
    switch (opcode)
    {
        case OAMP_MEP_TX_OPCODE_CCM_BFD:
            ...
            SHR_IF_ERR_EXIT(dnx_oam_oamp_mep_db_get(unit, mep_id, oamp_params));
    ...
    dnx_oam_mep_profile_t * mep_profile_data)
{
    ...
    SHR_IF_ERR_EXIT(dnx_oam_oamp_get_existing_phase_cnt_for_opcode
    ...
    if (my_scan_rate != 0xffffffff)
    {
        ...
        if (other_cnt_2 == DNX_OAM_OAMP_ETH1731_MEP_PROFILE_MAX_CCM_CNT)
        {
            if (other_cnt != DNX_OAM_OAMP_ETH1731_MEP_PROFILE_MAX_CCM_CNT)
            {
                ...
                SHR_IF_ERR_EXIT(dnx_oam_oamp_get_existing_scan_rate_for_opcode
