    ...
    uint32 *max_watermark)
{
     ...
     */
    temp_access_info.dbal_table = dbal_table;

    /*
     * get min watermark
     */
    SHR_IF_ERR_EXIT(dnx_fabric_cgm_control_adaptive_factor_hw_get
                    (unit, &temp_access_info, DBAL_FIELD_EMPTY, DBAL_FIELD_MIN_WATERMARK, min_watermark));

    /*
     * get max watermark
     */
    SHR_IF_ERR_EXIT(dnx_fabric_cgm_control_adaptive_factor_hw_get
                    (unit, &temp_access_info, DBAL_FIELD_EMPTY, DBAL_FIELD_MAX_WATERMARK, max_watermark));
