...
#ifdef BCM_DNX2_SUPPORT
/* { */
    dnx_bfd_oamp_v1_only_temp_mep_db_data_t *mep_v1_only_hw_write_data = NULL;
    dnx_bfd_oamp_v1_only_endpoint_t *mep_v1_only_entry_values = NULL;
    dnx_bfd_oamp_v1_only_endpoint_t *new_mep_v1_only_entry_values = NULL;
    dnx_bfd_oamp_v1_only_temp_db_delete_data_t *oamp_v1_only_hw_delete_data = NULL;
/* } */
#endif
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FUNC_INIT_VARS(unit);
...
#ifdef BCM_DNX2_SUPPORT
/* { */
        SHR_ALLOC_SET_ZERO(mep_v1_only_hw_write_data, sizeof(dnx_bfd_oamp_v1_only_temp_mep_db_data_t),
                           "Data saved to write to OAMP MEP DB table", "%s%s%s\r\n", EMPTY, EMPTY, EMPTY);

        SHR_ALLOC_SET_ZERO(mep_v1_only_entry_values, sizeof(dnx_bfd_oamp_v1_only_endpoint_t),
                           "Structure used to call OAMP MEP DB get", "%s%s%s\r\n", EMPTY, EMPTY, EMPTY);
        SHR_ALLOC_SET_ZERO(new_mep_v1_only_entry_values, sizeof(dnx_bfd_oamp_v1_only_endpoint_t),
                           "Structure used to call OAMP MEP DB create", "%s%s%s\r\n", EMPTY, EMPTY, EMPTY);
        SHR_ALLOC_SET_ZERO(oamp_v1_only_hw_delete_data, sizeof(dnx_bfd_oamp_v1_only_temp_db_delete_data_t),
...
/* { */
            ...
            if (_SHR_IS_FLAG_SET(endpoint_info->flags, BCM_BFD_ENDPOINT_IPV6))
            {
                mep_v1_only_entry_values->flags = DNX_OAMP_BFD_IPV6;
            }

            /** Read from OAMP MEP DB table */
            SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_mep_db_endpoint_get
                            (unit, endpoint_info->id, mep_v1_only_entry_values));

            /** Modify the relevant reference counts */
            SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_modify_data_in_templates(unit, endpoint_info, existing_endpoint_info,
                                                                          mep_v1_only_entry_values, rmep_entry_values,
                                                                          oamp_v1_only_hw_delete_data,
                                                                          mep_v1_only_hw_write_data,
                                                                          rmep_hw_write_data));
            /** Build structure for creating OAMP MEP DB entry */
            SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_endpoint_db_build_param_for_mep_db
                            (unit, endpoint_info, mep_v1_only_hw_write_data, hw_update_data->bfd_sw_state_flags,
                             new_mep_v1_only_entry_values));
            mep_type = mep_v1_only_entry_values->mep_type;
/* } */
#endif
        }
...
#ifdef BCM_DNX2_SUPPORT
/* { */
            SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_endpoint_db_write_to_hw
                            (unit, mep_v1_only_hw_write_data, rmep_hw_write_data));

            SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_endpoint_db_delete_from_hw
                            (unit, mep_v1_only_entry_values, rmep_entry_values, oamp_v1_only_hw_delete_data,
                             &rmep_hw_write_data->punt_good_profile));
         /** Write to OAMP MEP DB table */
            new_mep_v1_only_entry_values->flags |= DNX_OAMP_BFD_MEP_UPDATE;
            SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_mep_db_endpoint_set
                            (unit, endpoint_info, new_mep_v1_only_entry_values));
/* } */
#endif
        }
...
#ifdef BCM_DNX2_SUPPORT
/* { */
    SHR_FREE(new_mep_v1_only_entry_values);
    SHR_FREE(mep_v1_only_entry_values);
    SHR_FREE(mep_v1_only_entry_values);
    SHR_FREE(oamp_v1_only_hw_delete_data);
/* } */
#endif
...
/* { */
        ...
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_build_endpoint_id(unit, endpoint_info, hw_write_data));
/* } */
#endif
    }
...
#ifdef BCM_DNX2_SUPPORT
/* { */
            mep_v1_only_hw_write_data->endpoint_id = endpoint_info->id;
            if (_SHR_IS_FLAG_SET(hw_write_data->action_flags, DNX_OAM_MPLS_LM_DM_MEP))
            {
                /** For MPLS-LM-DM, avoid allocating the MEP DB entry */
                mep_v1_only_entry_values->flags |= DNX_OAMP_OAM_CCM_MEP_UPDATE;
                mep_v1_only_entry_values->mpls_lm_dm_entry = hw_write_data->gathered_data.mpls_lm_dm_entry;
                /** This endpoint already has a MEP profile - get it */
                mep_v1_only_hw_write_data->mep_profile = hw_write_data->gathered_data.mep_profile;
                SHR_IF_ERR_EXIT(algo_oam_db.oam_mep_profile.profile_data_get
                                (unit, hw_write_data->gathered_data.mep_profile, &dummy,
                                 &mep_v1_only_hw_write_data->mep_profile_data));
            }
            else
            {
                mep_v1_only_hw_write_data->mep_profile = 0xFF;
            }
                /** Templates for endpoint accelerated to local OAMP   */
            SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_write_data_to_templates
                            (unit, endpoint_info, mep_v1_only_hw_write_data, rmep_hw_write_data));

                /** Build structure for creating OAMP MEP DB entry */
            SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_endpoint_db_build_param_for_mep_db
                            (unit, endpoint_info, mep_v1_only_hw_write_data, hw_write_data->bfd_sw_state_flags,
                             mep_v1_only_entry_values));
            mep_type = mep_v1_only_entry_values->mep_type;
/* } */
#endif
        }
...
/* { */
        ...
        /** Write to OAMP MEP DB table */
            SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_mep_db_endpoint_set(unit, endpoint_info, mep_v1_only_entry_values));
/* } */
#endif
        }
...
/* { */
        ...
        SHR_IF_ERR_EXIT(dnx_bfd_pwe_with_lm_dm_verify(unit, endpoint_info));
/* } */
#endif
...
#ifdef BCM_DNX2_SUPPORT
/* { */
    dnx_bfd_oamp_v1_only_temp_mep_db_data_t *mep_v1_only_sw_read_data = NULL;
    dnx_bfd_oamp_v1_only_endpoint_t *mep_v1_only_entry_values = NULL;
/* } */
#endif
    SHR_FUNC_INIT_VARS(unit);
...
#ifdef BCM_DNX2_SUPPORT
/* { */
            SHR_ALLOC_SET_ZERO(mep_v1_only_sw_read_data, sizeof(dnx_bfd_oamp_v1_only_temp_mep_db_data_t),
            ...
            /** Read from OAMP MEP DB table */
            SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_mep_db_endpoint_get(unit, endpoint, mep_v1_only_entry_values));

            sal_memcpy(endpoint_info->dst_ip6_addr, mep_v1_only_entry_values->ipv6_dip, sizeof(bcm_ip6_t));
            sal_memcpy(endpoint_info->src_ip6_addr, mep_v1_only_entry_values->ipv6_sip, sizeof(bcm_ip6_t));
/* } */
#endif
        }
...
/* { */
            ...
            dnx_bfd_oamp_v1_only_endpoint_db_analyze_param_from_oamp_mep_db(unit, endpoint_info,
                                                                            mep_v1_only_sw_read_data,
                                                                            mep_v1_only_entry_values);
/* } */
#endif
        }
...
/* { */
            ...
            SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_read_data_from_templates
                            (unit, endpoint_info, mep_v1_only_sw_read_data, rmep_sw_read_data));
/* } */
#endif
        }
...
/* { */
    SHR_FREE(mep_v1_only_entry_values);
    SHR_FREE(mep_v1_only_sw_read_data);
/* } */
#endif
    SHR_FREE(rmep_entry_values);
...
/* { */
            ...
            oamp_v1_only_hw_delete_data->seamless_bfd =
                (_SHR_IS_FLAG_SET
                 (hw_delete_data->bfd_sw_state_flags, DBAL_DEFINE_BFD_ENDPOINT_SW_STATE_FLAGS_SEAMLESS_BFD_INITIATOR));
            oamp_v1_only_hw_delete_data->mpls_lm_dm = is_mpls_lm_dm;
            SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_delete_data_from_templates
                            (unit, endpoint, mep_v1_only_entry_values, rmep_entry_values, oamp_v1_only_hw_delete_data,
...
/* { */
            ...
            if (is_mpls_lm_dm)
            {
                ...
                SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_set_mpls_lm_dm_mep_profile(unit, endpoint,
                                                                                oamp_v1_only_hw_delete_data->mpls_lm_dm_only_profile));
            }
            else
            {
                SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_mep_db_endpoint_clear
                                (unit, endpoint,
                                 _SHR_IS_FLAG_SET(hw_delete_data->bfd_sw_state_flags,
            ...
            SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_only_endpoint_db_delete_from_hw
                            (unit, mep_v1_only_entry_values, rmep_entry_values, oamp_v1_only_hw_delete_data,
                             punt_good_hw_write_data));
            oam_type = mep_v1_only_entry_values->mep_type;
/* } */
#endif
        }
        ...
        SHR_IF_ERR_EXIT(dnx_bfd_endpoint_db_get_const_for_oamp_rmep_index_db(unit, oam_type, &rmep_index_const));
