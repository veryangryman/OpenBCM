    ...
    else
    {
        ...
        else
        {
            ...
            if (!_SHR_IS_FLAG_SET(tunnel->flags, BCM_TUNNEL_REPLACE))
            {
                ...
                if (tunnel_is_ipv6 &&
                    (((tunnel->type != bcmTunnelTypeSR6) && (tunnel->type != bcmTunnelTypeEthIn6)) || (srv6_with_dip)))
                {
                ...
                if ((tunnel->type != bcmTunnelTypeSR6) && (tunnel->type != bcmTunnelTypeEthIn6))
                {
                    srv6_with_dip = 0;
                }
    ...
    bcm_tunnel_initiator_t * tunnel)
{
    ...
    if (tunnel_is_ipv6)
    {
        if (((tunnel->type != bcmTunnelTypeSR6) && (tunnel->type != bcmTunnelTypeEthIn6)) || srv6_with_dip)
        {
