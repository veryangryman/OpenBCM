...
static sh_sand_cmd_t sh_dnx_commands[] = {
  /* Name                 | Leaf Action          | Junction Array Pointer         | Options for Leaf         | Usage */
    ...
    {"field",               NULL,                  Sh_dnx_field_cmds,               NULL,                      &Sh_dnx_field_man       , NULL, NULL, CTEST_POSTCOMMIT| SH_CMD_SKIP_MEMORY_CHECK},
    ...
    {"PP",                  NULL,                  sh_dnx_pp_cmds,                  NULL,                      &sh_dnx_pp_man          , NULL, NULL, CTEST_POSTCOMMIT| SH_CMD_SKIP_MEMORY_CHECK},
#ifdef INCLUDE_XFLOW_MACSEC
