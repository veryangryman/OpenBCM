    ...
    sh_sand_control_t * sand_control)
{
    ...
    SHR_IF_ERR_EXIT(dnx_fabric_cgm_control_adaptive_watermark_factor_get(unit,
                                                                         ...
                                                                         &min_watermark_a, &max_watermark_a));

    SHR_IF_ERR_EXIT(dnx_fabric_cgm_control_adaptive_watermark_factor_get(unit,
                                                                         DBAL_TABLE_FABRIC_CGM_ADAPTIVE_SHAPER_MNOL_CONTROL,
                                                                         &min_watermark_b, &max_watermark_b));

    PRT_ROW_ADD(PRT_ROW_SEP_NONE);
    PRT_CELL_SET("%s", "min_watermark");        /* Indication */
    PRT_CELL_SET("%d", min_watermark_a);        /* value */
    PRT_CELL_SET("%d", min_watermark_b);        /* value */

    PRT_ROW_ADD(PRT_ROW_SEP_NONE);
    PRT_CELL_SET("%s", "max_watermark");        /* Indication */
    PRT_CELL_SET("%d", max_watermark_a);        /* value */
    PRT_CELL_SET("%d", max_watermark_b);        /* value */
...
static sh_sand_cmd_t sh_dnx_fabric_cgm_adaptive_shaper_cmds[] = {
    ...
    {"status", sh_dnx_fabric_cgm_adaptive_shaper_status, NULL,    NULL, &sh_dnx_fabric_cgm_adaptive_shaper_status_man,   NULL, NULL, SH_CMD_NO_XML_VERIFY},
    {NULL}
};
