    ...
    int unit)
{
    ...
    presel_entry_data.qual_data[0].qual_value = dnx_data_port_pp.general.rch_removal_port_field_profile_get(unit);
    presel_entry_data.qual_data[0].qual_mask = dnx_data_port_pp.general.rch_removal_port_field_profile_get(unit);
    ...
    int unit)
{
    ...
    /** Check that the bit in the port profile is set */
    presel_entry_data.qual_data[0].qual_type = bcmFieldQualifyPortClassTrafficManagement;
    presel_entry_data.qual_data[0].qual_value =
        dnx_data_port_pp.general.rch_extended_encap_port_field_profile_get(unit);
