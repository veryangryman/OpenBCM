...
/** using -1 to put all '1' in the field, to mark as invalid */
field_srv6_egress_psp_info_t cint_field_srv6_egress_psp_ext_cut_info = {
    -1, -1, -1, -1,
    {-1, bcmFieldStageCount}, {-1, bcmFieldStageCount},
    bcmFieldQualifyCount, bcmFieldQualifyCount,
    bcmFieldQualifyCount, bcmFieldQualifyCount, bcmFieldQualifyCount,
    ...
    bcm_field_context_t * ctx_id)
{
    ...
    rv = bcm_field_context_create(unit, flags, stage, &context_info, ctx_id);
    if (rv != BCM_E_NONE)
    {
    ...
    uint8 is_psp)
{
    ...
    /**  in SRv6 Endpoint, after IPv6 termination, we set in fwd layer be again IPv6, for hashing of IPv6 layer in FWD */
    ...
    /*
     * Endpoint would occur if: -2nd qualifier check layer_qualifier[0] of SRv6 if SL!=0 in USP mode -or
     * layer_qualifier[1] (SL!=1) in PSP mode
     */
    ...
    uint8 is_ext_cut)
{
    ...
    /*
     * Endpoint PSP would occur if: layer_qualifier[1] (SL==1)
     */
    ipmf_presel_entry_data.qual_data[1].qual_type = bcmFieldQualifyForwardingLayerQualifier;
    ipmf_presel_entry_data.qual_data[1].qual_arg = srv6_relative_to_fwd_layer;
    if (!is_ext_cut)
    ...
    int presel_id)
{
    ...
    /*
     * Egress would occur if: -2nd qualifier check layer_qualifier[0] of SRv6 (SL==0) in USP mode -or
     * layer_qualifier[1] (SL==1) in PSP mode
     */
    ipmf_presel_entry_data.qual_data[1].qual_type = bcmFieldQualifyForwardingLayerQualifier;
    ipmf_presel_entry_data.qual_data[1].qual_arg = srv6_relative_to_fwd_layer;
    ...
    int presel_id)
{
    ...
    /*
     * Egress would occur if: -2nd qualifier check layer_qualifier[0] of SRv6 (SL==0) in USP mode
     */
    ...
    int unit)
{
    ...
    rv = bcm_field_qualifier_create(unit, 0, &qual_info, &udh_qual_0);
    if (rv != BCM_E_NONE)
    {
        printf("Error in bcm_field_qualifier_create UDH for usid\n");
        return rv;
    }
    ...
    rv = bcm_field_qualifier_create(unit, 0, &qual_info, &udh_qual_1);
    if (rv != BCM_E_NONE)
    {
        printf("Error in bcm_field_qualifier_create UDH for usid\n");
        return rv;
    ...
    rv = bcm_field_qualifier_create(unit, 0, &qual_info, &udh_qual_2);
    if (rv != BCM_E_NONE)
    {
        printf("Error in bcm_field_qualifier_create UDH for usid\n");
        return rv;
    ...
    rv = bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_srv6_usid_endpoint_info.udh_type_qual);
    if (rv != BCM_E_NONE)
    {
        printf("Error in bcm_field_qualifier_create UDH size  for usid\n");
        return rv;
    }
    ...
    rv = bcm_field_group_add(unit, 0, &fg_info, &cint_field_srv6_usid_endpoint_info.ipmf2_fg);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d), in bcm_field_group_add ipmf2_fg\n", rv);
        return rv;
    ...
    rv = bcm_field_group_context_attach(unit, 0, cint_field_srv6_usid_endpoint_info.ipmf2_fg,
    ...
    int unit)
{
    ...
    rv = bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_srv6_egress_usp_info.udh_qual);
    if (rv != BCM_E_NONE)
    {
        printf("Error in bcm_field_qualifier_create UDH\n");
        return rv;
    ...
    rv = bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_srv6_egress_usp_info.udh_type_qual);
    if (rv != BCM_E_NONE)
    {
        printf("Error in bcm_field_qualifier_create UDH size\n");
        return rv;
    ...
    if (rv != BCM_E_NONE)
    {
        printf("Error in bcm_field_qualifier_create srv6_usp_last_ent_q\n");
        return rv;
    }
    ...
    rv = bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_srv6_egress_usp_info.qual_id_fai_3_0);
    if (rv != BCM_E_NONE)
    {
        printf("Error in bcm_field_qualifier_create qual_id_fai_3_0\n");
        return rv;
    }
    ...
    int unit)
{
    ...
    rv = bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_srv6_egress_usd_info.srh_last_entry_qual);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_srv6_egress_usd_info.srh_next_header_pmf2_qual);
    if (rv != BCM_E_NONE)
    {
        printf("Error in bcm_field_qualifier_create srv6_usd_nxt_hdr_q2\n");
        return rv;
    }
    ...
    rv = bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_srv6_egress_usd_info.pmf2_esi_1st_pass_udh3_size);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_srv6_egress_usd_info.pmf2_esi_1st_pass_udh3_data);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = bcm_field_action_create(unit, 0, &action_info, &cint_field_srv6_egress_usd_info.container_void_action);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d) in bcm_field_action_create container_void_action\n", rv);
        return rv;
    ...
    */
    ...
    rv = bcm_field_action_create(unit, 0, &action_info, &cint_field_srv6_egress_usd_info.pmf2_udh3_esi_user_action);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = bcm_field_group_add(unit, 0, &fg_info, &cint_field_srv6_egress_usd_info.ipmf2_fg);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d), in bcm_field_group_add ipmf2_fg\n", rv);
        return rv;
     ...
     * BCM_FIELD_ACTION_POSITION() - Encoded position of the FEM to add to this FG.
     */
    rv = bcm_field_fem_action_add(unit, 0, cint_field_srv6_egress_usd_info.ipmf2_fg, BCM_FIELD_ACTION_POSITION(3, 2),
                                  &fem_action_info);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d), in bcm_field_fem_action_add ipmf2\n", rv);
    ...
    rv = bcm_field_group_context_attach(unit, 0, cint_field_srv6_egress_usd_info.ipmf2_fg,
    ...
    int unit)
{
    ...
    rv = bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_srv6_endpoint_info.parsing_index_qual);
    if (rv != BCM_E_NONE)
    {
    ...
    int unit)
{
    ...
    rv = bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_srv6_egress_usp_info.fwd_layer_idx_qual);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d) in bcm_field_qualifier_create srv6_usp_fwdlyr_idx_q\n", rv);
        return rv;
    }
    ...
    rv = bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_srv6_egress_usp_info.egress_parsing_idx_qual);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d) in bcm_field_qualifier_create srv6_usp_egr_prs_idx_q\n", rv);
        return rv;
    }
    ...
    rv = bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_srv6_egress_usp_info.parsing_nof_sids_qual);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d) in bcm_field_qualifier_create srv6_usp_nof_sids_q\n", rv);
        return rv;
    }
    ...
    rv = bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_srv6_egress_usp_info.msb_bits_tm_compensate_size);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d) in bcm_field_qualifier_create srv6_usp_msb_bit_tm_compens_q\n", rv);
        return rv;
    }
 ...
 */
static int
field_srv6_config_egress_psp_extended_cut_ipmf3_de(
    int unit)
{
    bcm_field_group_info_t fg_info;
    bcm_field_group_attach_info_t attach_info;
    ...
    param_info.param_arg = 0;
    rv = bcm_field_context_param_set(unit, 0, bcmFieldStageIngressPMF3,
                                     cint_field_srv6_egress_psp_ext_cut_info.ipmf3_context_id, &param_info);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d), in bcm_field_context_param_set\n", rv);
        return rv;
    ...
    rv = bcm_field_qualifier_create(unit, 0, &qual_info,
                                    &cint_field_srv6_egress_psp_ext_cut_info.parsing_start_type_valid_qual);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d) in bcm_field_qualifier_create parsing_start_type_valid_qual\n", rv);
        return rv;
    ...
    rv = bcm_field_qualifier_create(unit, 0, &qual_info,
                                    &cint_field_srv6_egress_psp_ext_cut_info.srv6_endpoint_layer_type_qual);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d) in bcm_field_qualifier_create srv6_endpoint_layer_type_qual\n", rv);
        return rv;
    ...
    rv = bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_srv6_egress_psp_ext_cut_info.fwd_layer_idx_qual);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d) in bcm_field_qualifier_create fwd_layer_idx_qual\n", rv);
        return rv;
    ...
    rv = bcm_field_qualifier_create(unit, 0, &qual_info,
                                    &cint_field_srv6_egress_psp_ext_cut_info.egress_parsing_idx_qual);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d) in bcm_field_qualifier_create egress_parsing_idx_qual\n", rv);
        return rv;
    ...
    fg_info.stage = bcmFieldStageIngressPMF3;
    dest_char = &(fg_info.name[0]);
    sal_strncpy_s(dest_char, "SRv6_egress_psp_ext_cut_ipmf3", sizeof(fg_info.name));
     ...
     */
    fg_info.nof_quals = 4;
    fg_info.qual_types[0] = cint_field_srv6_egress_psp_ext_cut_info.parsing_start_type_valid_qual;
    fg_info.qual_types[1] = cint_field_srv6_egress_psp_ext_cut_info.srv6_endpoint_layer_type_qual;
    fg_info.qual_types[2] = cint_field_srv6_egress_psp_ext_cut_info.fwd_layer_idx_qual;
    fg_info.qual_types[3] = cint_field_srv6_egress_psp_ext_cut_info.egress_parsing_idx_qual;
    ...
    rv = bcm_field_group_add(unit, 0, &fg_info, &cint_field_srv6_egress_psp_ext_cut_info.ipmf3_fg);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = bcm_field_group_context_attach(unit, 0, cint_field_srv6_egress_psp_ext_cut_info.ipmf3_fg,
                                        cint_field_srv6_egress_psp_ext_cut_info.ipmf3_context_id, &attach_info);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d), in bcm_field_group_context_attach ipmf3\n", rv);
        return rv;
    ...
    int unit)
{
    ...
    rv = bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_srv6_egress_usd_info.parsing_start_offset_valid);
    if (rv != BCM_E_NONE)
    {
    ...
    /**Qualifier for de on fwd offset*/
    rv = bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_srv6_egress_usd_info.parsing_start_offset);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = bcm_field_group_add(unit, 0, &fg_info, &cint_field_srv6_egress_usd_info.ipmf3_direct_fg);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = bcm_field_group_context_attach(unit, 0, cint_field_srv6_egress_usd_info.ipmf3_direct_fg,
    ...
    rv = bcm_field_group_context_attach(unit, 0, cint_field_srv6_egress_usd_info.ipmf3_tcam_fg,
                                        cint_field_srv6_egress_usd_info.ipmf3_context_id, &attach_info);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = bcm_field_entry_add(unit, 0, cint_field_srv6_egress_usd_info.ipmf3_tcam_fg, &tcam_ent_info, &tcam_entry_id);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = dnx_dbal_fields_enum_value_get(unit, "PARSING_START_TYPE_ENCODING", "MPLS", &hw_value);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d), in dnx_dbal_fields_enum_value_get for Layer Type MPLS \n", rv);
        return rv;
    }
    tcam_ent_info.entry_action[0].value[0] = hw_value << 1 | 1; /* The valid bit value is the LSB, and it's set to 1 */
    rv = bcm_field_entry_add(unit, 0, cint_field_srv6_egress_usd_info.ipmf3_tcam_fg, &tcam_ent_info, &tcam_entry_id);
    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(field_srv6_pmf1_usid_endpoint_presel_set
                    (unit, cint_field_srv6_usid_endpoint_info.ipmf1_context_id, 11));
    ...
    SHR_IF_ERR_EXIT(field_srv6_pmf3_presel_set
                    (unit, cint_field_srv6_usid_endpoint_info.ipmf1_context_id,
                     cint_field_srv6_endpoint_info.ipmf3_context_id, 14));
    ...
    int appl_psp_enable)
{
    ...
    SHR_IF_ERR_EXIT(field_srv6_pmf1_classic_endpoint_presel_set
                    (unit, cint_field_srv6_endpoint_info.ipmf1_context_id, 13, (uint8) appl_psp_enable));
    ...
    int unit)
{
     ...
     *  set by 8 MSB bits of the Outlif.
   ...
   /** Configure Compensation  */
    ...
    for (sid_compensation_size_entry = MIN_NOF_SIDS;
    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(field_srv6_pmf1_endpoint_psp_presel_set
                    (unit, cint_field_srv6_egress_psp_info.ipmf1_context_id, 15, 0));
    ...
    SHR_IF_ERR_EXIT(field_srv6_pmf3_presel_set
                    (unit, cint_field_srv6_egress_psp_info.ipmf1_context_id,
                     cint_field_srv6_egress_psp_info.ipmf3_context_id, 13));
    ...
    int unit)
{
    ...
    cint_field_srv6_egress_psp_ext_cut_info.ipmf1_context_id = 7;

     /** Egress PSP - create the context in PMF1 and name it */
    SHR_IF_ERR_EXIT(field_srv6_context_set
                    (unit, bcmFieldStageIngressPMF1, "SRv6_psp_ext_cut_pmf1", BCM_FIELD_FLAG_WITH_ID,
                     &cint_field_srv6_egress_psp_ext_cut_info.ipmf1_context_id));

     /** Egress PSP - create the Presel and attach it to the above context */
    SHR_IF_ERR_EXIT(field_srv6_pmf1_endpoint_psp_presel_set
                    (unit, cint_field_srv6_egress_psp_ext_cut_info.ipmf1_context_id, 14, 1));

    cint_field_srv6_egress_psp_ext_cut_info.ipmf3_context_id = 7;
    /** Egress - create the context in PMF3 and name it */
    SHR_IF_ERR_EXIT(field_srv6_context_set
                    (unit, bcmFieldStageIngressPMF3, "SRv6_psp_ext_cut_pmf3", BCM_FIELD_FLAG_WITH_ID,
                     &cint_field_srv6_egress_psp_ext_cut_info.ipmf3_context_id));

    /** Egress - create the Presel and attach it to the above context */
    SHR_IF_ERR_EXIT(field_srv6_pmf3_presel_set
                    (unit, cint_field_srv6_egress_psp_ext_cut_info.ipmf1_context_id,
                     cint_field_srv6_egress_psp_ext_cut_info.ipmf3_context_id, 10));

    /** Egress - Configure FG in PMF3 */
    SHR_IF_ERR_EXIT(field_srv6_config_egress_psp_extended_cut_ipmf3_de(unit));
