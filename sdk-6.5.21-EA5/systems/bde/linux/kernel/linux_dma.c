...
#ifndef CONFIG_CMA
#error ERROR: Kernel Contiguous Memory (CMA) support required for EDK. \
       Refer EDK documentation for more info.
#endif
#endif
...
#ifdef BCM_EDK_SUPPORT
#undef DMA_MEM_DEFAULT
#define DMA_MEM_DEFAULT (192 * ONE_MB)
#endif
