...
/**
 * \brief
 *  Used to hold trunk member.
 */
#define _SHR_GPORT_SUB_TYPE_TRUNK_MEMBER                (1)
...
/* SUB GPORT TRUNK MEMBER */
#define _SHR_GPORT_SUB_TYPE_TRUNK_MEMBER_SHIFT             (0)
#define _SHR_GPORT_SUB_TYPE_TRUNK_MEMBER_MASK       (0x3FFFFF)
...
/* given gport return if this is Trunk member subtype */
#define _SHR_GPORT_SUB_TYPE_IS_TRUNK_MEMBER(_gport)             \
    ((((_gport) >> _SHR_GPORT_SUB_TYPE_SHIFT) & _SHR_GPORT_SUB_TYPE_MASK) == _SHR_GPORT_SUB_TYPE_TRUNK_MEMBER)
...
/* Get GPORT subvalue of subtype Trunk Member */
#define _SHR_GPORT_SUB_TYPE_TRUNK_MEMBER_GET(_gport) \
    ((_SHR_GPORT_SUB_TYPE_GET(_gport) == _SHR_GPORT_SUB_TYPE_TRUNK_MEMBER) ? \
     (((_gport) >> _SHR_GPORT_SUB_TYPE_TRUNK_MEMBER_SHIFT) & _SHR_GPORT_SUB_TYPE_TRUNK_MEMBER_MASK):-1)
...
/* Set GPORT subvalue and subtype Trunk Member */
#define _SHR_GPORT_SUB_TYPE_TRUNK_MEMBER_SET(_gport, _trunk_member) \
    ((_gport) = (_SHR_GPORT_SUB_TYPE_TRUNK_MEMBER << _SHR_GPORT_SUB_TYPE_SHIFT)   | \
      (((_trunk_member) & _SHR_GPORT_SUB_TYPE_TRUNK_MEMBER_MASK) << _SHR_GPORT_SUB_TYPE_TRUNK_MEMBER_SHIFT))
