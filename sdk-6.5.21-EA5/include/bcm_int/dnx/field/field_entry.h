...
#define DNX_FIELD_STATE_TABLE_ENTRY_ADDRESS(entry_handle)        \
...
#define DNX_FIELD_STATE_TABLE_ENTRY(address, core_id)  \
                            (((core_id & DNX_DATA_FIELD_ENTRY_CORE_ID_MASK) << DNX_DATA_FIELD_ENTRY_CORE_ID_SHIFT) | \
