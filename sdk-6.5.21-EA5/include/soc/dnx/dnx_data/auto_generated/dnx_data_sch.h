...
typedef uint32(
    *dnx_data_sch_flow_flex_quartet_region_size_get_f) (
    int unit);


typedef uint32(
    *dnx_data_sch_flow_nof_flex_quartet_regions_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_sch_flow_flex_quartet_region_size_get_f flex_quartet_region_size_get;
    
    dnx_data_sch_flow_nof_flex_quartet_regions_get_f nof_flex_quartet_regions_get;
