...
typedef uint32(
    *dnx_data_instru_synced_counters_start_lags_get_f) (
    int unit);


typedef uint32(
    *dnx_data_instru_synced_counters_nif_traffic_not_working_get_f) (
    int unit);


typedef uint32(
    *dnx_data_instru_synced_counters_shifting_continuous_non_continuous_not_working_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_instru_synced_counters_start_lags_get_f start_lags_get;
    
    dnx_data_instru_synced_counters_nif_traffic_not_working_get_f nif_traffic_not_working_get;
    
    dnx_data_instru_synced_counters_shifting_continuous_non_continuous_not_working_get_f shifting_continuous_non_continuous_not_working_get;
