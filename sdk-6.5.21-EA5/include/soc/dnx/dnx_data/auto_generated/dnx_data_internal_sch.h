...
typedef enum
{
    ...
    dnx_data_sch_flow_define_flex_quartet_region_size,
    dnx_data_sch_flow_define_nof_flex_quartet_regions,
...
uint32 dnx_data_sch_flow_flex_quartet_region_size_get(
    int unit);


uint32 dnx_data_sch_flow_nof_flex_quartet_regions_get(
    int unit);
