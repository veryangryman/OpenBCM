...
typedef uint32(
    *dnx_data_nif_eth_is_12G_supported_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_nif_eth_is_12G_supported_get_f is_12G_supported_get;
...
typedef enum
{
    ...
    dnx_data_nif_features_toggle_lag_failover_on_link_status_up,
