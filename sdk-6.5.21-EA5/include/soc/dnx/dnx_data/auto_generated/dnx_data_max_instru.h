...
#define DNX_DATA_MAX_INSTRU_SYNCED_COUNTERS_START_LAGS (1)

#define DNX_DATA_MAX_INSTRU_SYNCED_COUNTERS_NIF_TRAFFIC_NOT_WORKING (1)

#define DNX_DATA_MAX_INSTRU_SYNCED_COUNTERS_SHIFTING_CONTINUOUS_NON_CONTINUOUS_NOT_WORKING (1)
