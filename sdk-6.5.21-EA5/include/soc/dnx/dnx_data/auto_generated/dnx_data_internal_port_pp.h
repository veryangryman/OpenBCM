...
typedef enum
{
    ...
    dnx_data_port_pp_general_define_rch_removal_port_field_profile,
    dnx_data_port_pp_general_define_rch_extended_encap_port_field_profile,
...
uint32 dnx_data_port_pp_general_rch_removal_port_field_profile_get(
    int unit);


uint32 dnx_data_port_pp_general_rch_extended_encap_port_field_profile_get(
    int unit);
