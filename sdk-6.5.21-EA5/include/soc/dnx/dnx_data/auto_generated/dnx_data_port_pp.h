...
typedef uint32(
    *dnx_data_port_pp_general_rch_removal_port_field_profile_get_f) (
    int unit);


typedef uint32(
    *dnx_data_port_pp_general_rch_extended_encap_port_field_profile_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_port_pp_general_rch_removal_port_field_profile_get_f rch_removal_port_field_profile_get;
    
    dnx_data_port_pp_general_rch_extended_encap_port_field_profile_get_f rch_extended_encap_port_field_profile_get;
