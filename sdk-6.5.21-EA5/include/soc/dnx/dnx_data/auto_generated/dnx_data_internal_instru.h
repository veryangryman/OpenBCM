...
typedef enum
{
    ...
    dnx_data_instru_synced_counters_define_start_lags,
    dnx_data_instru_synced_counters_define_nif_traffic_not_working,
    dnx_data_instru_synced_counters_define_shifting_continuous_non_continuous_not_working,
...
uint32 dnx_data_instru_synced_counters_start_lags_get(
    int unit);


uint32 dnx_data_instru_synced_counters_nif_traffic_not_working_get(
    int unit);


uint32 dnx_data_instru_synced_counters_shifting_continuous_non_continuous_not_working_get(
    int unit);
